...
*ApplicationsBetaApi* | [**create_application**](docs/ApplicationsBetaApi.md#create_application) | **POST** /api/v2/applications | Post application
...
*ApplicationsBetaApi* | [**post_application_version**](docs/ApplicationsBetaApi.md#post_application_version) | **POST** /api/v2/applications/{applicationKey}/versions | Post application version
