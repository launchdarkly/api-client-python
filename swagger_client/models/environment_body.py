...
class EnvironmentBody(object):
    ...
    def __init__(self, name=None, key=None, color=None, default_ttl=None):
        """
        EnvironmentBody - a model defined in Swagger
        """
    ...
    def color(self):
        """
        Gets the color of this EnvironmentBody.
        A color swatch (as an RGB hex value with no leading '#', e.g. C8C8C8)

        :return: The color of this EnvironmentBody.
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        ...
        :param color: The color of this EnvironmentBody.
        :type: str
        """
        if color is None:
