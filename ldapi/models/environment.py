...
class Environment(object):
    ...
    def __init__(self, links=None, id=None, key=None, name=None, api_key=None, mobile_key=None, color=None, default_ttl=None, secure_mode=None, default_track_events=None):  # noqa: E501
