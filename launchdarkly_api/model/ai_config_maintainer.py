...
def lazy_import():
    ...
    globals()['AiConfigsMaintainerTeam'] = AiConfigsMaintainerTeam
    globals()['MaintainerMember'] = MaintainerMember


class AIConfigMaintainer(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AIConfigMaintainer - a model defined in OpenAPI
