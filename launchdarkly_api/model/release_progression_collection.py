...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['PhaseInfo'] = PhaseInfo
    globals()['ReleaseProgression'] = ReleaseProgression


class ReleaseProgressionCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'active_count': (int,),  # noqa: E501
            'completed_count': (int,),  # noqa: E501
            'items': ([ReleaseProgression],),  # noqa: E501
            'phases': ([PhaseInfo],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, active_count, completed_count, items, phases, total_count, links, *args, **kwargs):  # noqa: E501
        """ReleaseProgressionCollection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, active_count, completed_count, items, phases, total_count, links, *args, **kwargs):  # noqa: E501
        """ReleaseProgressionCollection - a model defined in OpenAPI
