...
def lazy_import():
    ...
    globals()['InsightsRepositoryProject'] = InsightsRepositoryProject


class InsightsRepositoryProjectMappings(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'mappings': ([InsightsRepositoryProject],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mappings, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryProjectMappings - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, mappings, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryProjectMappings - a model defined in OpenAPI
