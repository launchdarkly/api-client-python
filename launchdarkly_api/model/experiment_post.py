...
class ExperimentPost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, description, maintainer_id, key, iteration, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, maintainer_id, key, iteration, *args, **kwargs):  # noqa: E501
        """ExperimentPost - a model defined in OpenAPI
