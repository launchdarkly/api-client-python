...
class EnvironmentSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, key, name, color, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, key, name, color, *args, **kwargs):  # noqa: E501
        """EnvironmentSummary - a model defined in OpenAPI
