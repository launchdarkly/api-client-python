...
class PostInsightGroupParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, key, project_key, environment_key, *args, **kwargs):  # noqa: E501
        """PostInsightGroupParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            application_keys ([str]): The application keys to associate with the insight group. If not provided, the insight group will include data from all applications.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, key, project_key, environment_key, *args, **kwargs):  # noqa: E501
        """PostInsightGroupParams - a model defined in OpenAPI
