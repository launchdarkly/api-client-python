...
class InsightsRepositoryProject(ModelNormal):
    ...
    attribute_map = {
        'repository_key': 'repositoryKey',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, repository_key, project_key, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryProject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, repository_key, project_key, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryProject - a model defined in OpenAPI
