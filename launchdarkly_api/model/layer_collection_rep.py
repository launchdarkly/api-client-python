...
def lazy_import():
    ...
    globals()['LayerRep'] = LayerRep
    globals()['Link'] = Link


class LayerCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, items, total_count, links, *args, **kwargs):  # noqa: E501
        """LayerCollectionRep - a model defined in OpenAPI

        Args:
            items ([LayerRep]): The layers in the project
