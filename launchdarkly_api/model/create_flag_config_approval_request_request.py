...
class CreateFlagConfigApprovalRequestRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, instructions, notify_member_ids, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, instructions, notify_member_ids, *args, **kwargs):  # noqa: E501
        """CreateFlagConfigApprovalRequestRequest - a model defined in OpenAPI
