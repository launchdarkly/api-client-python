...
def lazy_import():
    ...
    globals()['BigSegmentStoreIntegration'] = BigSegmentStoreIntegration
    globals()['BigSegmentStoreIntegrationCollectionLinks'] = BigSegmentStoreIntegrationCollectionLinks


class BigSegmentStoreIntegrationCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (BigSegmentStoreIntegrationCollectionLinks,),  # noqa: E501
            'items': ([BigSegmentStoreIntegration],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, links, items, *args, **kwargs):  # noqa: E501
        """BigSegmentStoreIntegrationCollection - a model defined in OpenAPI

        Args:
            links (BigSegmentStoreIntegrationCollectionLinks):
            items ([BigSegmentStoreIntegration]): An array of persistent store integration configurations
