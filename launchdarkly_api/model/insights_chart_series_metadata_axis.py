...
class InsightsChartSeriesMetadataAxis(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, unit, *args, **kwargs):  # noqa: E501
        """InsightsChartSeriesMetadataAxis - a model defined in OpenAPI
