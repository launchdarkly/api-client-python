...
def lazy_import():
    ...
    globals()['AccessDeniedReasonRep'] = AccessDeniedReasonRep


class AccessDeniedRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'reason': (AccessDeniedReasonRep,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, action, reason, *args, **kwargs):  # noqa: E501
        """AccessDeniedRep - a model defined in OpenAPI
