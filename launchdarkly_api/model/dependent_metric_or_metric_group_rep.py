...
class DependentMetricOrMetricGroupRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, version_id, name, kind, links, is_group, *args, **kwargs):  # noqa: E501
        """DependentMetricOrMetricGroupRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            metrics ([MetricInGroupRep]): An ordered list of the metrics in this metric group. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, version_id, name, kind, links, is_group, *args, **kwargs):  # noqa: E501
        """DependentMetricOrMetricGroupRep - a model defined in OpenAPI
