...
def lazy_import():
    ...
    globals()['CustomWorkflowOutputRep'] = CustomWorkflowOutputRep


class CustomWorkflowsListingOutputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([CustomWorkflowOutputRep],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """CustomWorkflowsListingOutputRep - a model defined in OpenAPI
