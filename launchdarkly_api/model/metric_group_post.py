...
def lazy_import():
    ...
    globals()['MetricInMetricGroupInput'] = MetricInMetricGroupInput


class MetricGroupPost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tags': ([str],),  # noqa: E501
            'metrics': ([MetricInMetricGroupInput],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, maintainer_id, tags, metrics, *args, **kwargs):  # noqa: E501
        """MetricGroupPost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, maintainer_id, tags, metrics, *args, **kwargs):  # noqa: E501
        """MetricGroupPost - a model defined in OpenAPI
