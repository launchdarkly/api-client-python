...
class Member(ModelNormal):
    ...
    def _from_openapi_data(cls, links, id, role, email, pending_invite, verified, custom_roles, mfa, last_seen, creation_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            pending_email (str): [optional]  # noqa: E501
            ...
            teams ([MemberTeamSummaryRep]): [optional]  # noqa: E501
            permission_grants ([MemberPermissionGrantSummaryRep]): [optional]  # noqa: E501
            oauth_providers ([str]): [optional]  # noqa: E501
        """
