...
class CreateAnnouncementBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_dismissible, title, message, start_time, severity, *args, **kwargs):  # noqa: E501
        """CreateAnnouncementBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_dismissible, title, message, start_time, severity, *args, **kwargs):  # noqa: E501
        """CreateAnnouncementBody - a model defined in OpenAPI
