...
class MetricGroupRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, key, name, kind, links, tags, creation_date, last_modified, maintainer, metrics, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, key, name, kind, links, tags, creation_date, last_modified, maintainer, metrics, version, *args, **kwargs):  # noqa: E501
        """MetricGroupRep - a model defined in OpenAPI
