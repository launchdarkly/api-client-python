...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['MaintainerRep'] = MaintainerRep
    globals()['MetricInGroupRep'] = MetricInGroupRep


class MetricGroupRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'maintainer': (MaintainerRep,),  # noqa: E501
            'metrics': ([MetricInGroupRep],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, key, name, links, tags, creation_date, last_modified, maintainer, metrics, version, *args, **kwargs):  # noqa: E501
        """MetricGroupRep - a model defined in OpenAPI
        ...
        Keyword Args:
            kind (str): The type of the metric group. defaults to "funnel", must be one of ["funnel", ]  # noqa: E501
            ...
            description (str): Description of the metric group. [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            experiments (DependentExperimentListRep): [optional]  # noqa: E501
            experiment_count (int): The number of experiments using this metric group. [optional]  # noqa: E501
        """

        kind = kwargs.get('kind', "funnel")
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, key, name, links, tags, creation_date, last_modified, maintainer, metrics, version, *args, **kwargs):  # noqa: E501
        """MetricGroupRep - a model defined in OpenAPI
