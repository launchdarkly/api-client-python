...
class ProjectPost(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tags': ([str],),  # noqa: E501
            'environments': ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, name, key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            environments ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Creates the provided environments for this project. If omitted default environments will be created instead.. [optional]  # noqa: E501
        """
