...
class FlagPrerequisitePost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, variation_id, *args, **kwargs):  # noqa: E501
        """FlagPrerequisitePost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, variation_id, *args, **kwargs):  # noqa: E501
        """FlagPrerequisitePost - a model defined in OpenAPI
