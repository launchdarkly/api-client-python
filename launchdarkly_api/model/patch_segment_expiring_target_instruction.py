...
class PatchSegmentExpiringTargetInstruction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, kind, context_key, context_kind, target_type, *args, **kwargs):  # noqa: E501
        """PatchSegmentExpiringTargetInstruction - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (int): The time, in Unix milliseconds, when the context should be removed from this segment. Required if <code>kind</code> is <code>addExpiringTarget</code> or <code>updateExpiringTarget</code>.. [optional]  # noqa: E501
            version (int): The version of the expiring target to update. Optional and only used if <code>kind</code> is <code>updateExpiringTarget</code>. If included, update will fail if version doesn't match current version of the expiring target.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, kind, context_key, context_kind, target_type, *args, **kwargs):  # noqa: E501
        """PatchSegmentExpiringTargetInstruction - a model defined in OpenAPI
