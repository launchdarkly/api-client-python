...
def lazy_import():
    ...
    globals()['DeploymentRep'] = DeploymentRep
    globals()['Link'] = Link


class DeploymentCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """DeploymentCollectionRep - a model defined in OpenAPI

        Args:
            total_count (int): The total number of deployments
            items ([DeploymentRep]): A list of deployments
