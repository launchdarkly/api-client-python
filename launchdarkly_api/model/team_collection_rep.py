...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['TeamRep'] = TeamRep


class TeamCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TeamCollectionRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            items ([TeamRep]): [optional]  # noqa: E501
