...
def lazy_import():
    ...
    globals()['FlagReferenceRep'] = FlagReferenceRep


class FlagReferenceCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([FlagReferenceRep],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """FlagReferenceCollectionRep - a model defined in OpenAPI

        Args:
            total_count (int): The total number of flag references
            items ([FlagReferenceRep]): A list of flag references
