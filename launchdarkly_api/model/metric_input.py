...
class MetricInput(ModelNormal):
    ...
    def _from_openapi_data(cls, key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_group (bool): Whether this is a metric group (true) or a metric (false). Defaults to false. [optional]  # noqa: E501
            primary (bool): Deprecated, use <code>primarySingleMetricKey</code> and <code>primaryFunnelKey</code>. Whether this is a primary metric (true) or a secondary metric (false). [optional]  # noqa: E501
        """
