...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['MetricGroupRep'] = MetricGroupRep


class MetricGroupCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([MetricGroupRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """MetricGroupCollectionRep - a model defined in OpenAPI

        Args:
            items ([MetricGroupRep]): An array of metric groups
