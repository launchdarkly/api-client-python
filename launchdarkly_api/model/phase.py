...
class Phase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, audiences, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, audiences, name, *args, **kwargs):  # noqa: E501
        """Phase - a model defined in OpenAPI
