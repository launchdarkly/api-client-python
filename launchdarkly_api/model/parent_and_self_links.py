...
def lazy_import():
    ...
    globals()['CoreLink'] = CoreLink


class ParentAndSelfLinks(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            '_self': (CoreLink,),  # noqa: E501
            'parent': (CoreLink,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _self, parent, *args, **kwargs):  # noqa: E501
        """ParentAndSelfLinks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, _self, parent, *args, **kwargs):  # noqa: E501
        """ParentAndSelfLinks - a model defined in OpenAPI
