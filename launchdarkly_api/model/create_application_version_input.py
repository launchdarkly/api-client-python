...
class CreateApplicationVersionInput(ModelNormal):
    ...
    def _from_openapi_data(cls, key, name, *args, **kwargs):  # noqa: E501
        """CreateApplicationVersionInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            supported (bool): Whether this version is supported. Only applicable if the application <code>kind</code> is <code>mobile</code>. Defaults to <code>true</code>.. [optional]  # noqa: E501
        """
