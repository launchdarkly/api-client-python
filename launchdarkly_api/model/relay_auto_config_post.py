...
class RelayAutoConfigPost(ModelNormal):
    ...
    def _from_openapi_data(cls, name, policy, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            policy ([Statement]): A description of what environments and projects the Relay Proxy should include or exclude. To learn more, read [Write an inline policy](https://docs.launchdarkly.com/sdk/relay-proxy/automatic-configuration#write-an-inline-policy).
