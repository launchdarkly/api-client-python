...
class FeatureFlagConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, on, archived, salt, sel, last_modified, version, site, environment_name, track_events, track_events_fallthrough, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            targets ([Target]): An array of the individual targets that will receive a specific variation based on their key. [optional]  # noqa: E501
            context_targets ([Target]): [optional]  # noqa: E501
