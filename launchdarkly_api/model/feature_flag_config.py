...
class FeatureFlagConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, on, archived, salt, sel, last_modified, version, targets, rules, fallthrough, prerequisites, site, environment_name, track_events, track_events_fallthrough, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            off_variation (int): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, on, archived, salt, sel, last_modified, version, targets, rules, fallthrough, prerequisites, site, environment_name, track_events, track_events_fallthrough, *args, **kwargs):  # noqa: E501
        """FeatureFlagConfig - a model defined in OpenAPI
