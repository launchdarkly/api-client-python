...
class LayerPost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, description, *args, **kwargs):  # noqa: E501
        """LayerPost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, description, *args, **kwargs):  # noqa: E501
        """LayerPost - a model defined in OpenAPI
