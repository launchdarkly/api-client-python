...
def lazy_import():
    ...
    globals()['AccessDeniedRep'] = AccessDeniedRep


class AccessRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'denied': ([AccessDeniedRep],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, denied, *args, **kwargs):  # noqa: E501
        """AccessRep - a model defined in OpenAPI

        Args:
            denied ([AccessDeniedRep]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, denied, *args, **kwargs):  # noqa: E501
        """AccessRep - a model defined in OpenAPI
