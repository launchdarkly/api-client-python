...
def lazy_import():
    ...
    globals()['FailureReasonRep'] = FailureReasonRep


class ValidationFailedErrorRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'errors': ([FailureReasonRep],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, code, message, errors, *args, **kwargs):  # noqa: E501
        """ValidationFailedErrorRep - a model defined in OpenAPI
