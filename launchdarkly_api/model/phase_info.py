...
class PhaseInfo(ModelNormal):
    ...
    attribute_map = {
        'id': '_id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'release_count': 'releaseCount',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, release_count, *args, **kwargs):  # noqa: E501
        """PhaseInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, release_count, *args, **kwargs):  # noqa: E501
        """PhaseInfo - a model defined in OpenAPI
