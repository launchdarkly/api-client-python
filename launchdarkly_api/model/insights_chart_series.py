...
def lazy_import():
    ...
    globals()['InsightsChartSeriesDataPoint'] = InsightsChartSeriesDataPoint
    globals()['InsightsChartSeriesMetadata'] = InsightsChartSeriesMetadata


class InsightsChartSeries(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metadata': (InsightsChartSeriesMetadata,),  # noqa: E501
            'data': ([InsightsChartSeriesDataPoint],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, metadata, data, *args, **kwargs):  # noqa: E501
        """InsightsChartSeries - a model defined in OpenAPI

        Args:
            metadata (InsightsChartSeriesMetadata):
            data ([InsightsChartSeriesDataPoint]): Data points for the series
