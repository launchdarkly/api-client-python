...
class VariationEvalSummary(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VariationEvalSummary - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (bool, date, datetime, dict, float, int, list, str, none_type): The variation value. [optional]  # noqa: E501
            before (int): The number of evaluations in the ten minutes before the flag event. [optional]  # noqa: E501
            after (int): The number of evaluations in the ten minutes after the flag event. [optional]  # noqa: E501
        """
