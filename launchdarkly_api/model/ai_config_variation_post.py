...
class AIConfigVariationPost(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, messages, model, name, *args, **kwargs):  # noqa: E501
        """AIConfigVariationPost - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, messages, model, name, *args, **kwargs):  # noqa: E501
        """AIConfigVariationPost - a model defined in OpenAPI
