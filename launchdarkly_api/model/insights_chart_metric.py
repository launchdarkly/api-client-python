...
def lazy_import():
    ...
    globals()['InsightsMetricTierDefinition'] = InsightsMetricTierDefinition


class InsightsChartMetric(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tiers': ([InsightsMetricTierDefinition],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, indicator, value, unit, modifier, tiers, *args, **kwargs):  # noqa: E501
        """InsightsChartMetric - a model defined in OpenAPI
        ...
        Args:
            ...
            tiers ([InsightsMetricTierDefinition]): Metric indicator tiers
    ...
    @convert_js_args_to_python_args
    def __init__(self, indicator, value, unit, modifier, tiers, *args, **kwargs):  # noqa: E501
        """InsightsChartMetric - a model defined in OpenAPI
