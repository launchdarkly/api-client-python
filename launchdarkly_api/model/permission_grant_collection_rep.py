...
def lazy_import():
    ...
    globals()['PermissionGrantRep'] = PermissionGrantRep


class PermissionGrantCollectionRep(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PermissionGrantCollectionRep - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PermissionGrantRep]):  # noqa: E501

        Keyword Args:
            value ([PermissionGrantRep]):  # noqa: E501
