...
def lazy_import():
    ...
    globals()['AudiencePost'] = AudiencePost
    globals()['PhaseConfiguration'] = PhaseConfiguration


class CreatePhaseInput(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'audiences': ([AudiencePost],),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, audiences, name, *args, **kwargs):  # noqa: E501
        """CreatePhaseInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, audiences, name, *args, **kwargs):  # noqa: E501
        """CreatePhaseInput - a model defined in OpenAPI
