...
class EnvironmentPost(ModelNormal):
    ...
    def _from_openapi_data(cls, name, key, color, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            secure_mode (bool): Secure mode ensures that a user of the client-side SDK cannot impersonate another user.. [optional]  # noqa: E501
            default_track_events (bool): Enables tracking detailed information for new flags by default.. [optional]  # noqa: E501
            confirm_changes (bool): Require confirmation for all flag and segment changes via the UI in this environment.. [optional]  # noqa: E501
            require_comments (bool): Require comments for all flag and segment changes via the UI in this environment.. [optional]  # noqa: E501
