...
class Extinction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, revision, time, flag_key, project_key, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, revision, time, flag_key, project_key, *args, **kwargs):  # noqa: E501
        """Extinction - a model defined in OpenAPI
