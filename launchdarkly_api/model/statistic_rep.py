...
class StatisticRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, source_link, default_branch, enabled, version, hunk_count, links, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, source_link, default_branch, enabled, version, hunk_count, links, *args, **kwargs):  # noqa: E501
        """StatisticRep - a model defined in OpenAPI
