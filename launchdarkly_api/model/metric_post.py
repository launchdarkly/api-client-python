...
class MetricPost(ModelNormal):
    ...
    def _from_openapi_data(cls, key, kind, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            selector (str): One or more CSS selectors. Required for click metrics.. [optional]  # noqa: E501
            urls ([UrlPost]): One or more target URLs. Required for click and pageview metrics.. [optional]  # noqa: E501
            is_active (bool): Whether to track a conversion when users take an action. Required for custom metrics. Either <code>isActive</code> or <code>isNumeric</code> may be true, but not both.. [optional]  # noqa: E501
            is_numeric (bool): Whether to track numeric changes in value against a baseline. Required for custom metrics. Either <code>isActive</code> or <code>isNumeric</code> may be true, but not both.. [optional]  # noqa: E501
            unit (str): The unit of measure. Only for numeric custom metrics.. [optional]  # noqa: E501
            event_key (str): The event name to use in your code. Required for custom metrics.. [optional]  # noqa: E501
            success_criteria (str): Success criteria. Required for numeric custom metrics.. [optional]  # noqa: E501
