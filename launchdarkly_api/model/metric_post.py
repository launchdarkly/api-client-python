...
class MetricPost(ModelNormal):
    ...
    def _from_openapi_data(cls, key, kind, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_numeric (bool): Whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>). Required for custom metrics.. [optional]  # noqa: E501
