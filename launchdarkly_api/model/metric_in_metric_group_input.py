...
class MetricInMetricGroupInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name_in_group, *args, **kwargs):  # noqa: E501
        """MetricInMetricGroupInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name_in_group, *args, **kwargs):  # noqa: E501
        """MetricInMetricGroupInput - a model defined in OpenAPI
