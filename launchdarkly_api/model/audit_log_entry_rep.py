...
class AuditLogEntryRep(ModelNormal):
    ...
    def _from_openapi_data(cls, links, id, account_id, date, accesses, kind, name, description, short_description, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            title_verb (str): [optional]  # noqa: E501
            title (str): [optional]  # noqa: E501
            target (TargetResourceRep): [optional]  # noqa: E501
            parent (ParentResourceRep): [optional]  # noqa: E501
            delta (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            trigger_body (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            merge (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            previous_version (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            current_version (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
