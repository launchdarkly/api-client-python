...
class FlagRep(ModelNormal):
    ...
    def _from_openapi_data(cls, links, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            targeting_rule_clauses ([bool, date, datetime, dict, float, int, list, str, none_type]): Clause(s) used for targeting certain users by their attributes. [optional]  # noqa: E501
