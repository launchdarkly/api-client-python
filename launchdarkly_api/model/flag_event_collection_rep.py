...
def lazy_import():
    ...
    globals()['FlagEventRep'] = FlagEventRep
    globals()['Link'] = Link


class FlagEventCollectionRep(ModelNormal):
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """FlagEventCollectionRep - a model defined in OpenAPI

        Args:
            total_count (int): The total number of flag events
            items ([FlagEventRep]): A list of flag events
