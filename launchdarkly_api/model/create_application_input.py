...
def lazy_import():
    from launchdarkly_api.model.maintainer_input import MaintainerInput
    globals()['MaintainerInput'] = MaintainerInput


class CreateApplicationInput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'maintainer': (MaintainerInput,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, kind, name, *args, **kwargs):  # noqa: E501
        """CreateApplicationInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            maintainer (MaintainerInput): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, kind, name, *args, **kwargs):  # noqa: E501
        """CreateApplicationInput - a model defined in OpenAPI
