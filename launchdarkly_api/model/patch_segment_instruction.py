...
class PatchSegmentInstruction(ModelNormal):
    ...
    def _from_openapi_data(cls, kind, user_key, target_type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            value (int): Schedule user target expiration on a segment by including a timestamp. [optional]  # noqa: E501
            version (int): Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>. [optional]  # noqa: E501
        """
