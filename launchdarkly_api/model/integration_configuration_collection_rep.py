...
def lazy_import():
    ...
    globals()['IntegrationConfigurationsRep'] = IntegrationConfigurationsRep
    globals()['Link'] = Link


class IntegrationConfigurationCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([IntegrationConfigurationsRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, links, *args, **kwargs):  # noqa: E501
        """IntegrationConfigurationCollectionRep - a model defined in OpenAPI

        Args:
            items ([IntegrationConfigurationsRep]): An array of integration configurations
