...
class DependentMetricGroupRepWithMetrics(ModelNormal):
    ...
    def _from_openapi_data(cls, key, name, links, *args, **kwargs):  # noqa: E501
        """DependentMetricGroupRepWithMetrics - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            metrics ([MetricInGroupRep]): The metrics in the metric group. [optional]  # noqa: E501
        """
