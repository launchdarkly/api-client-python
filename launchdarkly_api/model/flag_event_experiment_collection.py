...
def lazy_import():
    ...
    globals()['FlagEventExperiment'] = FlagEventExperiment


class FlagEventExperimentCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([FlagEventExperiment],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """FlagEventExperimentCollection - a model defined in OpenAPI

        Args:
            total_count (int): The total number of experiments
            items ([FlagEventExperiment]): A list of experiments
