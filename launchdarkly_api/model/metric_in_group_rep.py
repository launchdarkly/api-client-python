...
class MetricInGroupRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, kind, links, name_in_group, *args, **kwargs):  # noqa: E501
        ...
        self.kind = kind
        self.links = links
        self.name_in_group = name_in_group
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, kind, links, name_in_group, *args, **kwargs):  # noqa: E501
        """MetricInGroupRep - a model defined in OpenAPI
