...
class LayerReservationRep(ModelNormal):
    ...
    attribute_map = {
        'experiment_key': 'experimentKey',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, experiment_key, flag_key, reservation_percent, *args, **kwargs):  # noqa: E501
        """LayerReservationRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, experiment_key, flag_key, reservation_percent, *args, **kwargs):  # noqa: E501
        """LayerReservationRep - a model defined in OpenAPI
