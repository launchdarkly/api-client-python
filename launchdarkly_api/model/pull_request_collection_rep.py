...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['PullRequestRep'] = PullRequestRep


class PullRequestCollectionRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([PullRequestRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """PullRequestCollectionRep - a model defined in OpenAPI

        Args:
            total_count (int): The total number of pull requests
            items ([PullRequestRep]): A list of pull requests
