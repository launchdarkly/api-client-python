...
class LayerPatchInput(ModelNormal):
    ...
    def _from_openapi_data(cls, instructions, *args, **kwargs):  # noqa: E501
        """LayerPatchInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            environment_key (str): The environment key used for making environment specific updates. For example, updating the reservation of an experiment. [optional]  # noqa: E501
        """
