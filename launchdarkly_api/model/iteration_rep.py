...
class IterationRep(ModelNormal):
    ...
    def _from_openapi_data(cls, hypothesis, status, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            winning_treatment_id (str): The ID of the treatment with the probability to be best. [optional]  # noqa: E501
            winning_reason (str): The reason you stopped the experiment. [optional]  # noqa: E501
            can_reshuffle_traffic (bool): Whether the experiment is allowed to reassign users to different variations (true) or must keep users assigned to their initial variation (false).. [optional]  # noqa: E501
