...
class MetricEventDefaultRep(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MetricEventDefaultRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            disabled (bool): Whether to disable defaulting missing unit events when calculating results. Defaults to false. [optional]  # noqa: E501
            value (float): The default value applied to missing unit events. Set to 0 when <code>disabled</code> is false. No other values are currently supported.. [optional]  # noqa: E501
        """
