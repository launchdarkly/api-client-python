...
class FlagEventExperimentIteration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, status, started_at, *args, **kwargs):  # noqa: E501
        """FlagEventExperimentIteration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, status, started_at, *args, **kwargs):  # noqa: E501
        """FlagEventExperimentIteration - a model defined in OpenAPI
