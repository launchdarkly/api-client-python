...
class FlagImportIntegrationLinks(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _self, parent, project, *args, **kwargs):  # noqa: E501
        """FlagImportIntegrationLinks - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, _self, parent, project, *args, **kwargs):  # noqa: E501
        """FlagImportIntegrationLinks - a model defined in OpenAPI
