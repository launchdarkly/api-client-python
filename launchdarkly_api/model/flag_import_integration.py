...
def lazy_import():
    ...
    globals()['FlagImportIntegrationLinks'] = FlagImportIntegrationLinks
    globals()['FlagImportStatus'] = FlagImportStatus
    globals()['FormVariableConfig'] = FormVariableConfig


class FlagImportIntegration(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (FlagImportIntegrationLinks,),  # noqa: E501
            'id': (str,),  # noqa: E501
            ...
            'status': (FlagImportStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, integration_key, project_key, config, tags, name, version, status, *args, **kwargs):  # noqa: E501
        """FlagImportIntegration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, integration_key, project_key, config, tags, name, version, status, *args, **kwargs):  # noqa: E501
        """FlagImportIntegration - a model defined in OpenAPI
