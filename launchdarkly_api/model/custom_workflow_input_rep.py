...
def lazy_import():
    ...
    globals()['StageInputRep'] = StageInputRep


class CustomWorkflowInputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'stages': ([StageInputRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, description, *args, **kwargs):  # noqa: E501
        """CustomWorkflowInputRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): The workflow name. [optional]  # noqa: E501
            stages ([StageInputRep]): [optional]  # noqa: E501
