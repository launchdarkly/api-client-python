...
class MetricRep(ModelNormal):
    ...
    def _from_openapi_data(cls, id, key, name, kind, links, tags, creation_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_numeric (bool): For custom metrics, whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when users taken an action (<code>false</code>).. [optional]  # noqa: E501
            success_criteria (str): For numeric custom metrics, the success criteria. [optional]  # noqa: E501
