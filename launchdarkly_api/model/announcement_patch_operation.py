...
class AnnouncementPatchOperation(ModelNormal):
    ...
    def _from_openapi_data(cls, op, path, *args, **kwargs):  # noqa: E501
        """AnnouncementPatchOperation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (bool, date, datetime, dict, float, int, list, str, none_type): A JSON value used in \"add\", \"replace\", and \"test\" operations. [optional]  # noqa: E501
        """
