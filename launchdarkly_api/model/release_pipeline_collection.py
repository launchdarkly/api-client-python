...
def lazy_import():
    ...
    globals()['ReleasePipeline'] = ReleasePipeline


class ReleasePipelineCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ReleasePipeline],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, total_count, *args, **kwargs):  # noqa: E501
        """ReleasePipelineCollection - a model defined in OpenAPI

        Args:
            items ([ReleasePipeline]): An array of release pipelines
