...
class CoreLink(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, href, type, *args, **kwargs):  # noqa: E501
        """CoreLink - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, href, type, *args, **kwargs):  # noqa: E501
        """CoreLink - a model defined in OpenAPI
