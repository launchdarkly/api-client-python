...
class InsightsMetricTierDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, indicator, description, *args, **kwargs):  # noqa: E501
        """InsightsMetricTierDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, indicator, description, *args, **kwargs):  # noqa: E501
        """InsightsMetricTierDefinition - a model defined in OpenAPI
