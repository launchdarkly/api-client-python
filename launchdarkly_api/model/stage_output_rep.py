...
def lazy_import():
    ...
    globals()['ActionOutputRep'] = ActionOutputRep
    globals()['ConditionOutputRep'] = ConditionOutputRep
    globals()['ExecutionOutputRep'] = ExecutionOutputRep


class StageOutputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'conditions': ([ConditionOutputRep],),  # noqa: E501
            'action': (ActionOutputRep,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, conditions, action, execution, *args, **kwargs):  # noqa: E501
        """StageOutputRep - a model defined in OpenAPI

        Args:
            id (str):
            conditions ([ConditionOutputRep]):
