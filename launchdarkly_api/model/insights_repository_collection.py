...
def lazy_import():
    ...
    globals()['InsightsRepository'] = InsightsRepository
    globals()['Link'] = Link


class InsightsRepositoryCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([InsightsRepository],),  # noqa: E501
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryCollection - a model defined in OpenAPI

        Args:
            total_count (int): Total number of repositories
            items ([InsightsRepository]): List of repositories
