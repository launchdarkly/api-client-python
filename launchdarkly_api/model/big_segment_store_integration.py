...
def lazy_import():
    ...
    globals()['BigSegmentStoreIntegrationLinks'] = BigSegmentStoreIntegrationLinks
    globals()['BigSegmentStoreStatus'] = BigSegmentStoreStatus
    globals()['FormVariableConfig'] = FormVariableConfig


class BigSegmentStoreIntegration(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'links': (BigSegmentStoreIntegrationLinks,),  # noqa: E501
            'id': (str,),  # noqa: E501
            ...
            'status': (BigSegmentStoreStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, integration_key, project_key, environment_key, config, on, tags, name, version, status, *args, **kwargs):  # noqa: E501
        """BigSegmentStoreIntegration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, integration_key, project_key, environment_key, config, on, tags, name, version, status, *args, **kwargs):  # noqa: E501
        """BigSegmentStoreIntegration - a model defined in OpenAPI
