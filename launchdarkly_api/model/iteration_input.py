...
class IterationInput(ModelNormal):
    ...
    def _from_openapi_data(cls, hypothesis, metrics, treatments, flags, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            can_reshuffle_traffic (bool): Whether to allow the experiment to reassign users to different variations (true) or keep users assigned to their initial variation (false). Defaults to true.. [optional]  # noqa: E501
        """
