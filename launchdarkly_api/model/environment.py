...
class Environment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'resource_approval_settings': ({str: (ApprovalSettings,)},),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'approval_settings': 'approvalSettings',  # noqa: E501
        'resource_approval_settings': 'resourceApprovalSettings',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, require_comments, confirm_changes, tags, critical, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            resource_approval_settings ({str: (ApprovalSettings,)}): Details on the approval settings for this environment for each resource kind. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, require_comments, confirm_changes, tags, critical, *args, **kwargs):  # noqa: E501
        """Environment - a model defined in OpenAPI
