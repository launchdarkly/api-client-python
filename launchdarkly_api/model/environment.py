...
class Environment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, tags, *args, **kwargs):  # noqa: E501
        """Environment - a model defined in OpenAPI

        Args:
            links ({str: (Link,)}): Links to related resources.
            id (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, id, key, name, api_key, mobile_key, color, default_ttl, secure_mode, default_track_events, tags, *args, **kwargs):  # noqa: E501
        """Environment - a model defined in OpenAPI
