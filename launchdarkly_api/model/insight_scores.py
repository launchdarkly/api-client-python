...
def lazy_import():
    ...
    globals()['InsightPeriod'] = InsightPeriod
    globals()['Link'] = Link


class InsightScores(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'period': (InsightPeriod,),  # noqa: E501
            'last_period': (InsightPeriod,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, period, last_period, scores, *args, **kwargs):  # noqa: E501
        """InsightScores - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, period, last_period, scores, *args, **kwargs):  # noqa: E501
        """InsightScores - a model defined in OpenAPI
