...
class FeatureFlag(ModelNormal):
    ...
    def _from_openapi_data(cls, name, kind, key, version, creation_date, variations, temporary, tags, links, experiments, custom_properties, archived, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            deprecated (bool): Boolean indicating if the feature flag is deprecated. [optional]  # noqa: E501
            ...
            environments ({str: (FeatureFlagConfig,)}): Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.. [optional]  # noqa: E501
        """
