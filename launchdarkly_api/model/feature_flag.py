...
def lazy_import():
    ...
    globals()['FlagMigrationSettingsRep'] = FlagMigrationSettingsRep
    globals()['Link'] = Link
...
class FeatureFlag(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'deprecated_date': (int,),  # noqa: E501
            'defaults': (Defaults,),  # noqa: E501
            'purpose': (str,),  # noqa: E501
            'migration_settings': (FlagMigrationSettingsRep,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, kind, key, version, creation_date, variations, temporary, tags, links, experiments, custom_properties, archived, deprecated, environments, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            environments ({str: (FeatureFlagConfig,)}): Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.
        ...
        Keyword Args:
            ...
            goal_ids ([str]): Deprecated, use <code>experiments</code> instead. [optional]  # noqa: E501
            archived_date (int): [optional]  # noqa: E501
            deprecated_date (int): [optional]  # noqa: E501
            defaults (Defaults): [optional]  # noqa: E501
            purpose (str): [optional]  # noqa: E501
            migration_settings (FlagMigrationSettingsRep): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, kind, key, version, creation_date, variations, temporary, tags, links, experiments, custom_properties, archived, deprecated, environments, *args, **kwargs):  # noqa: E501
        """FeatureFlag - a model defined in OpenAPI
