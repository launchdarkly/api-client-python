...
def lazy_import():
    ...
    globals()['ConflictOutputRep'] = ConflictOutputRep
    globals()['ExecutionOutputRep'] = ExecutionOutputRep
    globals()['Link'] = Link
    globals()['StageOutputRep'] = StageOutputRep


class CustomWorkflowOutputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'conflicts': ([ConflictOutputRep],),  # noqa: E501
            'creation_date': (int,),  # noqa: E501
            'maintainer_id': (str,),  # noqa: E501
            'links': ({str: (Link,)},),  # noqa: E501
            'name': (str,),  # noqa: E501
            'execution': (ExecutionOutputRep,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'kind': (str,),  # noqa: E501
            'stages': ([StageOutputRep],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, id, version, conflicts, creation_date, maintainer_id, links, name, execution, *args, **kwargs):  # noqa: E501
        """CustomWorkflowOutputRep - a model defined in OpenAPI

        Args:
            id (str):
            version (int):
            conflicts ([ConflictOutputRep]):
            creation_date (int):
            maintainer_id (str):
            links ({str: (Link,)}):
            name (str):
            execution (ExecutionOutputRep):
        ...
        Keyword Args:
            ...
            stages ([StageOutputRep]): [optional]  # noqa: E501
        """
