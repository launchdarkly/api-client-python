...
def lazy_import():
    ...
    globals()['ExperimentBayesianResultsRep'] = ExperimentBayesianResultsRep
    globals()['MetricInGroupRep'] = MetricInGroupRep


class MetricInGroupResultsRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metric': (MetricInGroupRep,),  # noqa: E501
            'results': (ExperimentBayesianResultsRep,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metric, results, *args, **kwargs):  # noqa: E501
        """MetricInGroupResultsRep - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, metric, results, *args, **kwargs):  # noqa: E501
        """MetricInGroupResultsRep - a model defined in OpenAPI
