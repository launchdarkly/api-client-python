...
def lazy_import():
    ...
    globals()['MetricByVariation'] = MetricByVariation


class MetricsByVariation(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MetricsByVariation - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MetricByVariation]):  # noqa: E501

        Keyword Args:
            value ([MetricByVariation]):  # noqa: E501
