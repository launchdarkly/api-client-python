...
class SegmentBody(ModelNormal):
    ...
    def _from_openapi_data(cls, name, key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            unbounded (bool): Whether to create a standard segment (false) or a Big Segment (true). Only use a Big Segment if you need to add more than 15,000 users.. [optional]  # noqa: E501
        """
