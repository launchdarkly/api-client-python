...
def lazy_import():
    ...
    globals()['InsightGroupsCountByIndicator'] = InsightGroupsCountByIndicator


class InsightGroupCollectionMetadata(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'count_by_indicator': (InsightGroupsCountByIndicator,),  # noqa: E501
        }
    ...
    attribute_map = {
        'count_by_indicator': 'countByIndicator',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count_by_indicator, *args, **kwargs):  # noqa: E501
        """InsightGroupCollectionMetadata - a model defined in OpenAPI
        ...
        self.count_by_indicator = count_by_indicator
    ...
    @convert_js_args_to_python_args
    def __init__(self, count_by_indicator, *args, **kwargs):  # noqa: E501
        """InsightGroupCollectionMetadata - a model defined in OpenAPI
