...
def lazy_import():
    ...
    globals()['ReviewOutputRep'] = ReviewOutputRep


class ConditionOutputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'all_reviews': ([ReviewOutputRep],),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, execution, description, notify_member_ids, all_reviews, review_status, *args, **kwargs):  # noqa: E501
        """ConditionOutputRep - a model defined in OpenAPI
