...
class UserSegment(ModelNormal):
    ...
    def _from_openapi_data(cls, name, tags, creation_date, key, links, rules, version, deleted, generation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            included ([str]): An array of user keys for included users. Included users are always segment members, regardless of segment rules. For Big Segments this array is either empty or omitted.. [optional]  # noqa: E501
            excluded ([str]): An array of user keys for excluded users. Segment rules bypass excluded users, so they will never be included based on rules. Excluded users may still be included explicitly. This value is omitted for Big Segments.. [optional]  # noqa: E501
            access (Access): [optional]  # noqa: E501
            flags ([FlagListingRep]): [optional]  # noqa: E501
            unbounded (bool): Whether this is a standard segment (false) or a Big Segment (true). [optional]  # noqa: E501
