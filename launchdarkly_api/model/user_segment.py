...
class UserSegment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, tags, creation_date, last_modified_date, key, links, rules, version, deleted, generation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            included ([str]): An array of keys for included targets. Included individual targets are always segment members, regardless of segment rules. For list-based segments over 15,000 entries, also called big segments, this array is either empty or omitted.. [optional]  # noqa: E501
            excluded ([str]): An array of keys for excluded targets. Segment rules bypass individual excluded targets, so they will never be included based on rules. Excluded targets may still be included explicitly. This value is omitted for list-based segments over 15,000 entries, also called big segments.. [optional]  # noqa: E501
            ...
            flags ([FlagListingRep]): A list of flags targeting this segment. Only included when getting a single segment, using the <code>getSegment</code> endpoint.. [optional]  # noqa: E501
            unbounded (bool): Whether this is a standard segment (<code>false</code>) or a big segment (<code>true</code>). Standard segments include rule-based segments and smaller list-based segments. Big segments include larger list-based segments and synced segments. If omitted, the segment is a standard segment.. [optional]  # noqa: E501
            unbounded_context_kind (str): For big segments, the targeted context kind.. [optional]  # noqa: E501
            unbounded_metadata (SegmentMetadata): [optional]  # noqa: E501
            external (str): The external data store backing this segment. Only applies to synced segments.. [optional]  # noqa: E501
            external_link (str): The URL for the external data store backing this segment. Only applies to synced segments.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, tags, creation_date, last_modified_date, key, links, rules, version, deleted, generation, *args, **kwargs):  # noqa: E501
        """UserSegment - a model defined in OpenAPI
