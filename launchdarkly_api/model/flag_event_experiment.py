...
def lazy_import():
    ...
    globals()['FlagEventExperimentIteration'] = FlagEventExperimentIteration
    globals()['Link'] = Link


class FlagEventExperiment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'key': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'iteration': (FlagEventExperimentIteration,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, iteration, *args, **kwargs):  # noqa: E501
        """FlagEventExperiment - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, iteration, *args, **kwargs):  # noqa: E501
        """FlagEventExperiment - a model defined in OpenAPI
