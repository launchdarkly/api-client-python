...
class InsightsRepositoryProjectCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'items': ([InsightsRepositoryProject],),  # noqa: E501
    ...
    def _from_openapi_data(cls, total_count, items, *args, **kwargs):  # noqa: E501
        """InsightsRepositoryProjectCollection - a model defined in OpenAPI

        Args:
            total_count (int): Total number of repository project associations
            items ([InsightsRepositoryProject]): List of repository project associations
