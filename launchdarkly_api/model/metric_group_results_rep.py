...
def lazy_import():
    ...
    globals()['Link'] = Link
    globals()['MetricInGroupResultsRep'] = MetricInGroupResultsRep


class MetricGroupResultsRep(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'metrics': ([MetricInGroupResultsRep],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, metrics, *args, **kwargs):  # noqa: E501
        """MetricGroupResultsRep - a model defined in OpenAPI

        Args:
            links ({str: (Link,)}): The location and content type of related resources
            metrics ([MetricInGroupResultsRep]): An ordered list of the metrics in this metric group, and each of their results
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, metrics, *args, **kwargs):  # noqa: E501
        """MetricGroupResultsRep - a model defined in OpenAPI
