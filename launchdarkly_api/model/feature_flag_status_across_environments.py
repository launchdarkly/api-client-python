...
class FeatureFlagStatusAcrossEnvironments(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environments, key, links, *args, **kwargs):  # noqa: E501
        """FeatureFlagStatusAcrossEnvironments - a model defined in OpenAPI

        Args:
            environments ({str: (FeatureFlagStatus,)}): Flag status for environment.
    ...
    @convert_js_args_to_python_args
    def __init__(self, environments, key, links, *args, **kwargs):  # noqa: E501
        """FeatureFlagStatusAcrossEnvironments - a model defined in OpenAPI
