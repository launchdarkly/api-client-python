...
class ApplicationVersionRep(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, auto_added, key, name, *args, **kwargs):  # noqa: E501
        """ApplicationVersionRep - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            version (int): Version of the application version. [optional]  # noqa: E501
            creation_date (int): [optional]  # noqa: E501
            supported (bool): Whether this version is supported. Only applicable if the application <code>kind</code> is <code>mobile</code>.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, auto_added, key, name, *args, **kwargs):  # noqa: E501
        """ApplicationVersionRep - a model defined in OpenAPI
