...
class TriggerPost(ModelNormal):
    ...
    def _from_openapi_data(cls, integration_key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            instructions ([Instruction]): The action to perform when triggering. It should pass an array with a single {\"kind\": <flag_action>} object. Currently supported flag actions are \"turnFlagOn\" and \"turnFlagOff\".. [optional]  # noqa: E501
        """
