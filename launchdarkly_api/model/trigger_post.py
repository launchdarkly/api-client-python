...
class TriggerPost(ModelNormal):
    ...
    def _from_openapi_data(cls, integration_key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            instructions ([Instruction]): The action to perform when triggering. This should be an array with a single object that looks like {\"kind\": \"flag_action\"}. Supported flag actions are \"turnFlagOn\" and \"turnFlagOff\".. [optional]  # noqa: E501
        """
