...
def lazy_import():
    ...
    globals()['PatchSegmentExpiringTargetInstruction'] = PatchSegmentExpiringTargetInstruction


class PatchSegmentExpiringTargetInputRep(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'instructions': ([PatchSegmentExpiringTargetInstruction],),  # noqa: E501
    ...
    def _from_openapi_data(cls, instructions, *args, **kwargs):  # noqa: E501
        """PatchSegmentExpiringTargetInputRep - a model defined in OpenAPI

        Args:
            instructions ([PatchSegmentExpiringTargetInstruction]): Semantic patch instructions for the desired changes to the resource
