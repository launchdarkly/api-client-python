...
def lazy_import():
    ...
    globals()['AIConfig'] = AIConfig
    globals()['PaginatedLinks'] = PaginatedLinks


class AIConfigs(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([AIConfig],),  # noqa: E501
            'total_count': (int,),  # noqa: E501
            'links': (PaginatedLinks,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, items, total_count, *args, **kwargs):  # noqa: E501
        """AIConfigs - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            links (PaginatedLinks): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, items, total_count, *args, **kwargs):  # noqa: E501
        """AIConfigs - a model defined in OpenAPI
