...
class InstructionUserRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, kind, flag_key, variation_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            version (int): The version of the expiring user target to update. Optional and only used if <code>kind</code> is <code>updateExpireUserTargetDate</code>. If included, update will fail if version doesn't match current version of the expiring user target.. [optional]  # noqa: E501
        """
