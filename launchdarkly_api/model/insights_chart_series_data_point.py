...
class InsightsChartSeriesDataPoint(ModelNormal):
    ...
    def _from_openapi_data(cls, x, y, *args, **kwargs):  # noqa: E501
        """InsightsChartSeriesDataPoint - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            values ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Additional values for the data point. [optional]  # noqa: E501
        """
