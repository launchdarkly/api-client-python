...
def lazy_import():
    ...
    globals()['InsightsChartMetadata'] = InsightsChartMetadata
    globals()['InsightsChartSeries'] = InsightsChartSeries


class InsightsChart(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metadata': (InsightsChartMetadata,),  # noqa: E501
            'series': ([InsightsChartSeries],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metadata, series, *args, **kwargs):  # noqa: E501
        """InsightsChart - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, metadata, series, *args, **kwargs):  # noqa: E501
        """InsightsChart - a model defined in OpenAPI
