...
class AuditLogEntryRep(BaseModel):
    ...
    related_flag: Optional[RelatedFlag] = Field(default=None, alias="relatedFlag")
    related_experiment: Optional[RelatedExperiment] = Field(default=None, alias="relatedExperiment")
    related_ai_config: Optional[RelatedAIConfig] = Field(default=None, alias="relatedAIConfig")
    ...
    __properties: ClassVar[List[str]] = ["_links", "_id", "_accountId", "date", "accesses", "kind", "name", "description", "shortDescription", "comment", "relatedFlag", "relatedExperiment", "relatedAIConfig", "subject", "member", "token", "app", "titleVerb", "title", "target", "parent", "delta", "triggerBody", "merge", "previousVersion", "currentVersion", "subentries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of related_flag
        if self.related_flag:
            _dict['relatedFlag'] = self.related_flag.to_dict()
        # override the default output from pydantic by calling `to_dict()` of related_experiment
        if self.related_experiment:
            _dict['relatedExperiment'] = self.related_experiment.to_dict()
        # override the default output from pydantic by calling `to_dict()` of related_ai_config
        if self.related_ai_config:
            _dict['relatedAIConfig'] = self.related_ai_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relatedFlag": RelatedFlag.from_dict(obj["relatedFlag"]) if obj.get("relatedFlag") is not None else None,
            "relatedExperiment": RelatedExperiment.from_dict(obj["relatedExperiment"]) if obj.get("relatedExperiment") is not None else None,
            "relatedAIConfig": RelatedAIConfig.from_dict(obj["relatedAIConfig"]) if obj.get("relatedAIConfig") is not None else None,
