...
class ApprovalRequest(object):
    ...
    def __init__(self, id=None, version=None, creation_date=None, requestor_id=None, review_status=None, status=None, applied_by_member_id=None, applied_date=None, all_reviews=None, notify_member_ids=None, instructions=None, execution_date=None, operating_on_id=None):  # noqa: E501
