...
class MetricRep(BaseModel):
    ...
    denominator: Optional[MetricDenominatorRep] = None
    ...
    last_used_in_experiment: Optional[DependentExperimentRep] = Field(default=None, alias="lastUsedInExperiment")
    last_used_in_guarded_rollout: Optional[DependentMeasuredRolloutRep] = Field(default=None, alias="lastUsedInGuardedRollout")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.last_used_in_experiment:
            _dict['lastUsedInExperiment'] = self.last_used_in_experiment.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_used_in_guarded_rollout
        if self.last_used_in_guarded_rollout:
            _dict['lastUsedInGuardedRollout'] = self.last_used_in_guarded_rollout.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "denominator": MetricDenominatorRep.from_dict(obj["denominator"]) if obj.get("denominator") is not None else None,
            ...
            "lastUsedInExperiment": DependentExperimentRep.from_dict(obj["lastUsedInExperiment"]) if obj.get("lastUsedInExperiment") is not None else None,
            "lastUsedInGuardedRollout": DependentMeasuredRolloutRep.from_dict(obj["lastUsedInGuardedRollout"]) if obj.get("lastUsedInGuardedRollout") is not None else None,
