...
class FeatureFlag(BaseModel):
    ...
    environments: Optional[Dict[str, FeatureFlagConfig]] = Field(default=None, description="Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.")
