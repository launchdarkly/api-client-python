...
class FeatureFlag(object):
    ...
    def __init__(self, key=None, name=None, description=None, kind=None, creation_date=None, include_in_snippet=None, temporary=None, maintainer_id=None, tags=None, variations=None, goal_ids=None, version=None, custom_properties=None, links=None, maintainer=None, environments=None):  # noqa: E501
