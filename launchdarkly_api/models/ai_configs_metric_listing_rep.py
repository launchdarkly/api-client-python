...
class AiConfigsMetricListingRep(BaseModel):
    """
    ...
    links: Dict[str, AiConfigsLink] = Field(description="The location and content type of related resources", alias="_links")
    site: Optional[AiConfigsLink] = Field(default=None, alias="_site")
    ...
    last_modified: Optional[AiConfigsModification] = Field(default=None, alias="lastModified")
    ...
    maintainer: Optional[AiConfigsMemberSummary] = Field(default=None, alias="_maintainer")
    ...
    is_numeric: Optional[StrictBool] = Field(default=None, description="For custom and trace metrics, whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>).", alias="isNumeric")
    success_criteria: Optional[StrictStr] = Field(default=None, description="For custom and trace metrics, the success criteria", alias="successCriteria")
    unit: Optional[StrictStr] = Field(default=None, description="For numeric custom and trace metrics, the unit of measure")
    ...
    randomization_units: Optional[List[StrictStr]] = Field(default=None, description="Deprecated, use <code>analysisUnits</code> instead.", alias="randomizationUnits")
    analysis_units: Optional[List[StrictStr]] = Field(default=None, description="An array of analysis units allowed for this metric.", alias="analysisUnits")
    filters: Optional[AiConfigsFilter] = None
    ...
    window_start_offset: Optional[StrictInt] = Field(default=None, description="Not yet implemented - The start of the measurement window, in milliseconds relative to the unit's first exposure to a flag variation", alias="windowStartOffset")
    window_end_offset: Optional[StrictInt] = Field(default=None, description="Not yet implemented - The end of the measurement window, in milliseconds relative to the unit's first exposure to a flag variation", alias="windowEndOffset")
    winsor_lower_percentile: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Lower winsorization percentile, expressed as a percent in the open interval (0, 100). When both bounds are set, defines a two-sided clamp range. Otherwise lower-only winsorization.", alias="winsorLowerPercentile")
    winsor_upper_percentile: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Upper winsorization percentile, expressed as a percent in the open interval (0, 100). When both bounds are set, must be greater than winsorLowerPercentile.", alias="winsorUpperPercentile")
    winsor_exclude_imputed: Optional[StrictBool] = Field(default=None, description="Deprecated and ignored. Use winsorIncludeImputed instead.", alias="winsorExcludeImputed")
    winsor_include_imputed: Optional[StrictBool] = Field(default=None, description="When true, the percentile bound calculation includes imputed zeros. Only meaningful when at least one bound is set and the metric includes units that didn't send events.", alias="winsorIncludeImputed")
    trace_query: Optional[StrictStr] = Field(default=None, description="For trace metrics, the trace query to use for the metric.", alias="traceQuery")
    trace_value_location: Optional[StrictStr] = Field(default=None, description="For trace metrics, the location in the trace to use for numeric values.", alias="traceValueLocation")
    denominator: Optional[AiConfigsMetricDenominatorRep] = None
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pageview', 'click', 'custom', 'trace']):
            raise ValueError("must be one of enum values ('pageview', 'click', 'custom', 'trace')")
        return value
    ...
    def unit_aggregation_type_validate_enum(cls, value):
        ...
        if value not in set(['average', 'sum', 'count_distinct']):
            raise ValueError("must be one of enum values ('average', 'sum', 'count_distinct')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_links": dict(
                (_k, AiConfigsLink.from_dict(_v))
                for _k, _v in obj["_links"].items()
            )
            if obj.get("_links") is not None
            else None,
            "_site": AiConfigsLink.from_dict(obj["_site"]) if obj.get("_site") is not None else None,
            ...
            "lastModified": AiConfigsModification.from_dict(obj["lastModified"]) if obj.get("lastModified") is not None else None,
            "maintainerId": obj.get("maintainerId"),
            "_maintainer": AiConfigsMemberSummary.from_dict(obj["_maintainer"]) if obj.get("_maintainer") is not None else None,
            ...
            "analysisUnits": obj.get("analysisUnits"),
            "filters": AiConfigsFilter.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            ...
            "urls": obj.get("urls"),
            "windowStartOffset": obj.get("windowStartOffset"),
            "windowEndOffset": obj.get("windowEndOffset"),
            "winsorLowerPercentile": obj.get("winsorLowerPercentile"),
            "winsorUpperPercentile": obj.get("winsorUpperPercentile"),
            "winsorExcludeImputed": obj.get("winsorExcludeImputed"),
            "winsorIncludeImputed": obj.get("winsorIncludeImputed"),
            "traceQuery": obj.get("traceQuery"),
            "traceValueLocation": obj.get("traceValueLocation"),
            "denominator": AiConfigsMetricDenominatorRep.from_dict(obj["denominator"]) if obj.get("denominator") is not None else None
        })
        return _obj
