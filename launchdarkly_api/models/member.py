...
class Member(object):
    ...
    def __init__(self, links=None, id=None, role=None, email=None, first_name=None, last_name=None, verified=None, pending_invite=None, is_beta=None, custom_roles=None):  # noqa: E501
