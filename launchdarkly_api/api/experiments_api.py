...
class ExperimentsApi:
    ...
    def create_iteration(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/iterations is deprecated.", DeprecationWarning)
    ...
    def get_experiments_any_env(
        ...
        _param = self._get_experiments_any_env_serialize(
            project_key=project_key,
            limit=limit,
            offset=offset,
            filter=filter,
    ...
    @validate_call
    def get_experiments_any_env_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of experiments to return. Defaults to 20.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    @validate_call
    def get_experiments_any_env_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of experiments to return. Defaults to 20.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    def _get_experiments_any_env_serialize(
        self,
        project_key,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/experiments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
