...
class IntegrationsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_big_segment_store_integration_endpoint = _Endpoint(
            settings={
                'response_type': (BigSegmentStoreIntegration,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}',
                'operation_id': 'create_big_segment_store_integration',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.create_flag_import_configuration_endpoint = _Endpoint(
            settings={
                'response_type': (FlagImportIntegration,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}',
                'operation_id': 'create_flag_import_configuration',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'project_key': 'path',
                    'integration_key': 'path',
                    'flag_import_configuration_post': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.delete_big_segment_store_integration_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}',
                'operation_id': 'delete_big_segment_store_integration',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.delete_flag_import_configuration_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}',
                'operation_id': 'delete_flag_import_configuration',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_big_segment_store_integration_endpoint = _Endpoint(
            settings={
                'response_type': (BigSegmentStoreIntegration,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}',
                'operation_id': 'get_big_segment_store_integration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_big_segment_store_integrations_endpoint = _Endpoint(
            settings={
                'response_type': (BigSegmentStoreIntegrationCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/big-segment-store',
                'operation_id': 'get_big_segment_store_integrations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_import_configuration_endpoint = _Endpoint(
            settings={
                'response_type': (FlagImportIntegration,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}',
                'operation_id': 'get_flag_import_configuration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_import_configurations_endpoint = _Endpoint(
            settings={
                'response_type': (FlagImportIntegrationCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/flag-import',
                'operation_id': 'get_flag_import_configurations',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_big_segment_store_integration_endpoint = _Endpoint(
            settings={
                'response_type': (BigSegmentStoreIntegration,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}',
                'operation_id': 'patch_big_segment_store_integration',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.patch_flag_import_configuration_endpoint = _Endpoint(
            settings={
                'response_type': (FlagImportIntegration,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}',
                'operation_id': 'patch_flag_import_configuration',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.trigger_flag_import_job_endpoint = _Endpoint(
            settings={
                'response_type': (Object,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}/trigger',
                'operation_id': 'trigger_flag_import_job',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_big_segment_store_integration(
        ...
        **kwargs
        ...
        kwargs['integration_delivery_configuration_post'] = \
            integration_delivery_configuration_post
        return self.create_big_segment_store_integration_endpoint.call_with_http_info(**kwargs)
    ...
    def create_flag_import_configuration(
        ...
        **kwargs
        ...
        kwargs['integration_key'] = \
            integration_key
        kwargs['flag_import_configuration_post'] = \
            flag_import_configuration_post
        return self.create_flag_import_configuration_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_big_segment_store_integration(
        ...
        **kwargs
        ...
        """Delete big segment store integration  # noqa: E501

        Delete a persistent store integration. Each integration uses either Redis or DynamoDB.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_big_segment_store_integration(project_key, environment_key, integration_key, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['integration_id'] = \
            integration_id
        return self.delete_big_segment_store_integration_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_flag_import_configuration(
        ...
        **kwargs
        ...
        """Delete a flag import configuration  # noqa: E501

        Delete a flag import configuration by ID. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_flag_import_configuration(project_key, integration_key, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['integration_id'] = \
            integration_id
        return self.delete_flag_import_configuration_endpoint.call_with_http_info(**kwargs)
    ...
    def get_big_segment_store_integration(
        ...
        **kwargs
        ...
        """Get big segment store integration by ID  # noqa: E501

        Get a big segment store integration by ID.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_big_segment_store_integration(project_key, environment_key, integration_key, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['integration_id'] = \
            integration_id
        return self.get_big_segment_store_integration_endpoint.call_with_http_info(**kwargs)

    def get_big_segment_store_integrations(
        self,
        **kwargs
    ):
        """List all big segment store integrations  # noqa: E501

        List all big segment store integrations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_big_segment_store_integrations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_big_segment_store_integrations_endpoint.call_with_http_info(**kwargs)
    ...
    def get_flag_import_configuration(
        ...
        **kwargs
        ...
        """Get a single flag import configuration  # noqa: E501

        Get a single flag import configuration by ID. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_import_configuration(project_key, integration_key, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['integration_id'] = \
            integration_id
        return self.get_flag_import_configuration_endpoint.call_with_http_info(**kwargs)

    def get_flag_import_configurations(
        self,
        **kwargs
    ):
        """List all flag import configurations  # noqa: E501

        List all flag import configurations.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_import_configurations(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_flag_import_configurations_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_big_segment_store_integration(
        ...
        **kwargs
        ...
        """Update big segment store integration  # noqa: E501

        Update a big segment store integration. Updating a big segment store requires a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_big_segment_store_integration(project_key, environment_key, integration_key, integration_id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_big_segment_store_integration_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_flag_import_configuration(
        ...
        **kwargs
        ...
        """Update a flag import configuration  # noqa: E501
        ...
        >>> thread = api.patch_flag_import_configuration(project_key, integration_key, integration_id, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_flag_import_configuration_endpoint.call_with_http_info(**kwargs)
    ...
    def trigger_flag_import_job(
        ...
        **kwargs
        ...
        """Trigger a single flag import run  # noqa: E501

        Trigger a single flag import run for an existing flag import configuration. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trigger_flag_import_job(project_key, integration_key, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['integration_id'] = \
            integration_id
        return self.trigger_flag_import_job_endpoint.call_with_http_info(**kwargs)
