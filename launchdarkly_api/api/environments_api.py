...
class EnvironmentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.patch_environment = _Endpoint(
            settings={
                'response_type': (Environment,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__patch_environment
        )

        def __post_environment(
            self,
            project_key,
            environment_post,
            **kwargs
            ...
            > ### Approval settings > > The `approvalSettings` key is only returned when the Flag Approvals feature is enabled.  Create a new environment in a specified project with a given name, key, swatch color, and default TTL.   # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.post_environment = _Endpoint(
            settings={
                'response_type': (Environment,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_environment
        )

        def __reset_environment_mobile_key(
            self,
            project_key,
            env_key,
            **kwargs
        ...
        self.reset_environment_mobile_key = _Endpoint(
            settings={
                'response_type': (Environment,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__reset_environment_mobile_key
        )

        def __reset_environment_sdk_key(
            self,
            project_key,
            env_key,
            **kwargs
        ...
        self.reset_environment_sdk_key = _Endpoint(
            settings={
                'response_type': (Environment,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__reset_environment_sdk_key
        )
