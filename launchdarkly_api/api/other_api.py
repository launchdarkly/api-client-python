...
class OtherApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_openapi_spec(
            self,
            **kwargs
        ):
            """Gets the OpenAPI spec in json  # noqa: E501

            The OpenAPI spec endpoint serves the latest version of the OpenAPI specification for LaunchDarkly's API in json format.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_openapi_spec = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
        ...
        self.get_root = _Endpoint(
            settings={
                'response_type': ({str: (InlineResponse200,)},),
                'auth': [
                    'ApiKey'
                ],
