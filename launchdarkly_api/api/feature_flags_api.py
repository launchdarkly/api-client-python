...
class FeatureFlagsApi(object):
    ...
    def get_feature_flags(self, project_key, **kwargs):  # noqa: E501
        ...
        :param bool number: Where to start in the list. This is for use with pagination. For example, an offset of 10 would skip the first 10 items and then return the next limit items.
    ...
    def get_feature_flags_with_http_info(self, project_key, **kwargs):  # noqa: E501
        ...
        all_params = ['project_key', 'env', 'summary', 'archived', 'limit', 'number', 'filter', 'sort', 'tag']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def patch_expiring_user_targets(self, project_key, environment_key, feature_flag_key, patch_comment, **kwargs):  # noqa: E501
        """Update, add, or delete expiring user targets on feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_expiring_user_targets(project_key, environment_key, feature_flag_key, patch_comment, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_expiring_user_targets_with_http_info(project_key, environment_key, feature_flag_key, patch_comment, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_expiring_user_targets_with_http_info(project_key, environment_key, feature_flag_key, patch_comment, **kwargs)  # noqa: E501
            return data

    def patch_expiring_user_targets_with_http_info(self, project_key, environment_key, feature_flag_key, patch_comment, **kwargs):  # noqa: E501
        """Update, add, or delete expiring user targets on feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_expiring_user_targets_with_http_info(project_key, environment_key, feature_flag_key, patch_comment, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'environment_key', 'feature_flag_key', 'patch_comment']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('patch_comment' not in params or
            ...
            raise ValueError("Missing the required parameter `patch_comment` when calling `patch_expiring_user_targets`")  # noqa: E501
