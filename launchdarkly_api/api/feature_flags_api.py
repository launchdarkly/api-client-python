...
class FeatureFlagsApi(object):
    ...
    def delete_feature_flag_approval_request(self, project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Delete an approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_feature_flag_approval_request(project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        :param str feature_flag_key: The feature flag's key. The key identifies the flag in your code. (required)
        :param str feature_flag_approval_request_id: The feature flag approval request ID (required)
        :param FeatureFlagApprovalRequestConfigBody feature_flag_approval_request_config_body: Create a new feature flag approval request
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_feature_flag_approval_request_with_http_info(project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_feature_flag_approval_request_with_http_info(project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
            return data

    def delete_feature_flag_approval_request_with_http_info(self, project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Delete an approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_feature_flag_approval_request_with_http_info(project_key, environment_key, feature_flag_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'environment_key', 'feature_flag_key', 'feature_flag_approval_request_id', 'feature_flag_approval_request_config_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_feature_flag_approval_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `delete_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `delete_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `delete_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_id' is set
        if ('feature_flag_approval_request_id' not in params or
                params['feature_flag_approval_request_id'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_id` when calling `delete_feature_flag_approval_request`")  # noqa: E501
        ...
        if 'feature_flag_key' in params:
            path_params['featureFlagKey'] = params['feature_flag_key']  # noqa: E501
        if 'feature_flag_approval_request_id' in params:
            path_params['featureFlagApprovalRequestId'] = params['feature_flag_approval_request_id']  # noqa: E501
        ...
        body_params = None
        if 'feature_flag_approval_request_config_body' in params:
            body_params = params['feature_flag_approval_request_config_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def get_feature_flag_approval_request(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Get a single approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_feature_flag_approval_request(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
            return data

    def get_feature_flag_approval_request_with_http_info(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Get a single approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'feature_flag_key', 'environment_key', 'feature_flag_approval_request_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_feature_flag_approval_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `get_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `get_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `get_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_id' is set
        if ('feature_flag_approval_request_id' not in params or
                params['feature_flag_approval_request_id'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_id` when calling `get_feature_flag_approval_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FeatureFlagApprovalRequests',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_feature_flag_approval_requests(self, project_key, feature_flag_key, environment_key, **kwargs):  # noqa: E501
        """Get all approval requests for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_feature_flag_approval_requests(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_feature_flag_approval_requests_with_http_info(project_key, feature_flag_key, environment_key, **kwargs)  # noqa: E501
        else:
            (data) = self.get_feature_flag_approval_requests_with_http_info(project_key, feature_flag_key, environment_key, **kwargs)  # noqa: E501
            return data

    def get_feature_flag_approval_requests_with_http_info(self, project_key, feature_flag_key, environment_key, **kwargs):  # noqa: E501
        """Get all approval requests for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_feature_flag_approval_requests_with_http_info(project_key, feature_flag_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_feature_flag_approval_requests" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `get_feature_flag_approval_requests`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `get_feature_flag_approval_requests`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `get_feature_flag_approval_requests`")  # noqa: E501
    ...
    def post_apply_feature_flag_approval_request(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, **kwargs):  # noqa: E501
        """Apply approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_apply_feature_flag_approval_request(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, async_req=True)
        >>> result = thread.get()
        ...
        :param str environment_key: The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
        :param str feature_flag_approval_request_id: The feature flag approval request ID (required)
        :param FeatureFlagApprovalRequestApplyConfigBody feature_flag_approval_request_apply_config_body: Apply a new feature flag approval request (required)
        :return: FeatureFlagApprovalRequests
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_apply_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_apply_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, **kwargs)  # noqa: E501
            return data

    def post_apply_feature_flag_approval_request_with_http_info(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, **kwargs):  # noqa: E501
        """Apply approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_apply_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_apply_config_body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'feature_flag_key', 'environment_key', 'feature_flag_approval_request_id', 'feature_flag_approval_request_apply_config_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_apply_feature_flag_approval_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `post_apply_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `post_apply_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `post_apply_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_id' is set
        if ('feature_flag_approval_request_id' not in params or
                params['feature_flag_approval_request_id'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_id` when calling `post_apply_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_apply_config_body' is set
        if ('feature_flag_approval_request_apply_config_body' not in params or
                params['feature_flag_approval_request_apply_config_body'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_apply_config_body` when calling `post_apply_feature_flag_approval_request`")  # noqa: E501
        ...
        body_params = None
        if 'feature_flag_approval_request_apply_config_body' in params:
            body_params = params['feature_flag_approval_request_apply_config_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def post_feature_flag_approval_request(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Create an approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_feature_flag_approval_request(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs)  # noqa: E501
            return data

    def post_feature_flag_approval_request_with_http_info(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, **kwargs):  # noqa: E501
        """Create an approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'feature_flag_key', 'environment_key', 'feature_flag_approval_request_id', 'feature_flag_approval_request_config_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_feature_flag_approval_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `post_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `post_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `post_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_id' is set
        if ('feature_flag_approval_request_id' not in params or
                params['feature_flag_approval_request_id'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_id` when calling `post_feature_flag_approval_request`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FeatureFlagApprovalRequest',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_review_feature_flag_approval_request(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, **kwargs):  # noqa: E501
        """Review approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_review_feature_flag_approval_request(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, async_req=True)
        >>> result = thread.get()
        ...
        :param str environment_key: The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
        :param str feature_flag_approval_request_id: The feature flag approval request ID (required)
        :param FeatureFlagApprovalRequestReviewConfigBody feature_flag_approval_request_review_config_body: Review a feature flag approval request (required)
        :return: FeatureFlagApprovalRequests
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_review_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_review_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, **kwargs)  # noqa: E501
            return data

    def post_review_feature_flag_approval_request_with_http_info(self, project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, **kwargs):  # noqa: E501
        """Review approval request for a feature flag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_review_feature_flag_approval_request_with_http_info(project_key, feature_flag_key, environment_key, feature_flag_approval_request_id, feature_flag_approval_request_review_config_body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_key', 'feature_flag_key', 'environment_key', 'feature_flag_approval_request_id', 'feature_flag_approval_request_review_config_body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_review_feature_flag_approval_request" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_key' is set
        if ('project_key' not in params or
                params['project_key'] is None):
            raise ValueError("Missing the required parameter `project_key` when calling `post_review_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_key' is set
        if ('feature_flag_key' not in params or
                params['feature_flag_key'] is None):
            raise ValueError("Missing the required parameter `feature_flag_key` when calling `post_review_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'environment_key' is set
        if ('environment_key' not in params or
                params['environment_key'] is None):
            raise ValueError("Missing the required parameter `environment_key` when calling `post_review_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_id' is set
        if ('feature_flag_approval_request_id' not in params or
                params['feature_flag_approval_request_id'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_id` when calling `post_review_feature_flag_approval_request`")  # noqa: E501
        # verify the required parameter 'feature_flag_approval_request_review_config_body' is set
        if ('feature_flag_approval_request_review_config_body' not in params or
                params['feature_flag_approval_request_review_config_body'] is None):
            raise ValueError("Missing the required parameter `feature_flag_approval_request_review_config_body` when calling `post_review_feature_flag_approval_request`")  # noqa: E501
        ...
        body_params = None
        if 'feature_flag_approval_request_review_config_body' in params:
            body_params = params['feature_flag_approval_request_review_config_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
