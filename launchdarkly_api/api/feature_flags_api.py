...
class FeatureFlagsApi(object):
    ...
    def copy_feature_flag(self, project_key, environment_key, feature_flag_key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.copy_feature_flag(project_key, environment_key, feature_flag_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.copy_feature_flag_with_http_info(project_key, environment_key, feature_flag_key, **kwargs)  # noqa: E501
        else:
            (data) = self.copy_feature_flag_with_http_info(project_key, environment_key, feature_flag_key, **kwargs)  # noqa: E501
            return data

    def copy_feature_flag_with_http_info(self, project_key, environment_key, feature_flag_key, **kwargs):  # noqa: E501
        """Copies the feature flag configuration from one environment to the same feature flag in another environment.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.copy_feature_flag_with_http_info(project_key, environment_key, feature_flag_key, async_req=True)
        >>> result = thread.get()
        ...
        if ('environment_key' not in params or
            ...
            raise ValueError("Missing the required parameter `environment_key` when calling `copy_feature_flag`")  # noqa: E501
