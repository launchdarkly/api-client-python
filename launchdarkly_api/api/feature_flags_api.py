...
class FeatureFlagsApi(object):
    ...
    def patch_expiring_user_targets(
        ...
        **kwargs
        ...
        >>> thread = api.patch_expiring_user_targets(project_key, environment_key, feature_flag_key, patch_with_comment, async_req=True)
        >>> result = thread.get()
