    ...
    def __init__(self, api_client=None):
        ...
        def __get_dependent_flags(
            ...
            **kwargs
            ...
            List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_dependent_flags(proj_key, flag_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_dependent_flags = _Endpoint(
            settings={
                'response_type': (MultiEnvironmentDependentFlags,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projKey}/{flagKey}/dependent-flags',
            ...
            callable=__get_dependent_flags
        )

        def __get_dependent_flags_by_env(
            self,
            proj_key,
            env_key,
            flag_key,
            **kwargs
            ...
            >>> thread = api.get_dependent_flags_by_env(proj_key, env_key, flag_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_dependent_flags_by_env = _Endpoint(
            settings={
                'response_type': (DependentFlagsByEnvironment,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projKey}/{envKey}/{flagKey}/dependent-flags',
            ...
            api_client=api_client,
            callable=__get_dependent_flags_by_env
        )
