...
class InsightsChartsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_deployment_frequency_chart_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsChart,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/charts/deployments/frequency',
                'operation_id': 'get_deployment_frequency_chart',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_flag_status_chart_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsChart,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/charts/flags/status',
                'operation_id': 'get_flag_status_chart',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_lead_time_chart_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsChart,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/charts/lead-time',
                'operation_id': 'get_lead_time_chart',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_release_frequency_chart_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsChart,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/charts/releases/frequency',
                'operation_id': 'get_release_frequency_chart',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'environment_key': 'environmentKey',
                    'application_key': 'applicationKey',
                    'has_experiments': 'hasExperiments',
                    '_global': 'global',
                    'group_by': 'groupBy',
                    '_from': 'from',
                    'to': 'to',
        ...
        self.get_stale_flags_chart_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsChart,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/charts/flags/stale',
                'operation_id': 'get_stale_flags_chart',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_deployment_frequency_chart(
        ...
        **kwargs
        ...
        return self.get_deployment_frequency_chart_endpoint.call_with_http_info(**kwargs)
    ...
    def get_flag_status_chart(
        ...
        **kwargs
        ...
        """Get flag status chart data  # noqa: E501

        Get flag status chart data. To learn more, read [Flag statuses](https://launchdarkly.com/docs/home/observability/flag-health#flag-statuses).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flag_status_chart(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_flag_status_chart_endpoint.call_with_http_info(**kwargs)
    ...
    def get_lead_time_chart(
        ...
        **kwargs
        ...
        """Get lead time chart data  # noqa: E501

        Get lead time chart data. The engineering insights UI displays lead time data in the [lead time metric view](https://launchdarkly.com/docs/home/observability/lead-time).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_lead_time_chart(project_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_lead_time_chart_endpoint.call_with_http_info(**kwargs)
    ...
    def get_release_frequency_chart(
        ...
        **kwargs
        ...
        Get release frequency chart data. Engineering insights displays release frequency data in the [release frequency metric view](https://launchdarkly.com/docs/home/observability/releases).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_release_frequency_chart(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_release_frequency_chart_endpoint.call_with_http_info(**kwargs)
    ...
    def get_stale_flags_chart(
        ...
        **kwargs
        ...
        """Get stale flags chart data  # noqa: E501
        ...
        >>> thread = api.get_stale_flags_chart(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_stale_flags_chart_endpoint.call_with_http_info(**kwargs)
