...
class SDKKeysBetaApi:
    ...
    def delete_sdk_key_by_key(
        ...
        sdk_key_key: Annotated[StrictStr, Field(description="The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.")],
        ...
        :param environment_key: (required)
        :type environment_key: str
        :param sdk_key_key: The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value. (required)
        :type sdk_key_key: str
        ...
        _param = self._delete_sdk_key_by_key_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            environment_key=environment_key,
            sdk_key_key=sdk_key_key,
    ...
    @validate_call
    def delete_sdk_key_by_key_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    @validate_call
    def delete_sdk_key_by_key_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    def _delete_sdk_key_by_key_serialize(
        self,
        ld_api_version,
        project_key,
        environment_key,
        ...
        if sdk_key_key is not None:
            _path_params['sdkKeyKey'] = sdk_key_key
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/sdk-keys/{sdkKeyKey}',
    ...
    def get_sdk_key_by_key(
        ...
        _param = self._get_sdk_key_by_key_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            environment_key=environment_key,
            sdk_key_key=sdk_key_key,
    ...
    @validate_call
    def get_sdk_key_by_key_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    @validate_call
    def get_sdk_key_by_key_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    def _get_sdk_key_by_key_serialize(
        self,
        ld_api_version,
        project_key,
        environment_key,
    ...
    def get_sdk_keys(
        ...
        project_key: StrictStr,
        environment_key: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="A filter to apply to the list of SDK keys. Supports the following fields and operators: `kind` (equals \"sdk\" or \"mobile\"), `active` (equals true or false). Format: `field:value`. Example: `kind:sdk`.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of SDK keys to return. Defaults to 20. Maximum is 100.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The number of SDK keys to skip. Used for pagination.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="A sort to apply to the list of SDK keys. Supported field: `createdAt`. Prefix the field with `-` to sort in descending order (for example, `-createdAt`).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: (required)
        :type environment_key: str
        :param filter: A filter to apply to the list of SDK keys. Supports the following fields and operators: `kind` (equals \"sdk\" or \"mobile\"), `active` (equals true or false). Format: `field:value`. Example: `kind:sdk`.
        :type filter: str
        :param limit: The number of SDK keys to return. Defaults to 20. Maximum is 100.
        :type limit: int
        :param offset: The number of SDK keys to skip. Used for pagination.
        :type offset: int
        :param sort: A sort to apply to the list of SDK keys. Supported field: `createdAt`. Prefix the field with `-` to sort in descending order (for example, `-createdAt`).
        :type sort: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_sdk_keys_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            environment_key=environment_key,
            filter=filter,
    ...
    @validate_call
    def get_sdk_keys_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SdkKeysForGetSdkKeys]:
        """Get all environment SDK keys
    ...
    @validate_call
    def get_sdk_keys_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    def _get_sdk_keys_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/sdk-keys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_sdk_key_by_key(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
        sdk_key_key: Annotated[StrictStr, Field(description="The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.")],
        sdk_key_patch: Annotated[SdkKeyPatch, Field(description="An array of patches for updating an existing SDK key. The following fields are supported: `name`, `description`, `expiry`.")],
        version: Annotated[Optional[StrictInt], Field(description="The version of the SDK key for optimistic locking. If provided, the update will only succeed if the current version matches.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sdk_key_key: The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value. (required)
        :type sdk_key_key: str
        :param sdk_key_patch: An array of patches for updating an existing SDK key. The following fields are supported: `name`, `description`, `expiry`. (required)
        :type sdk_key_patch: SdkKeyPatch
        :param version: The version of the SDK key for optimistic locking. If provided, the update will only succeed if the current version matches.
        :type version: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._patch_sdk_key_by_key_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            environment_key=environment_key,
            sdk_key_key=sdk_key_key,
            sdk_key_patch=sdk_key_patch,
            version=version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_sdk_key_by_key_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    @validate_call
    def patch_sdk_key_by_key_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    def _patch_sdk_key_by_key_serialize(
        self,
        ld_api_version,
        project_key,
        environment_key,
        ...
        # process the form parameters
        # process the body parameter
        if sdk_key_patch is not None:
            _body_params = sdk_key_patch
    ...
    def post_sdk_key(
        ...
        project_key: StrictStr,
        environment_key: StrictStr,
        sdk_key_post: Annotated[SdkKeyPost, Field(description="Parameters for creating a new SDK key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: (required)
        :type environment_key: str
        :param sdk_key_post: Parameters for creating a new SDK key (required)
        :type sdk_key_post: SdkKeyPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_sdk_key_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            environment_key=environment_key,
            sdk_key_post=sdk_key_post,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_sdk_key_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    @validate_call
    def post_sdk_key_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: StrictStr,
    ...
    def _post_sdk_key_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if sdk_key_post is not None:
            _body_params = sdk_key_post
