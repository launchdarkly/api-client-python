...
class ReleasePipelinesBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_release_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}',
                'operation_id': 'delete_release_pipeline',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_all_release_pipelines_endpoint = _Endpoint(
            settings={
                'response_type': (ReleasePipelineCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines',
                'operation_id': 'get_all_release_pipelines',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_all_release_progressions_for_release_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (ReleaseProgressionCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}/releases',
                'operation_id': 'get_all_release_progressions_for_release_pipeline',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_release_pipeline_by_key_endpoint = _Endpoint(
            settings={
                'response_type': (ReleasePipeline,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}',
                'operation_id': 'get_release_pipeline_by_key',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_release_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (ReleasePipeline,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}',
                'operation_id': 'patch_release_pipeline',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_release_pipeline_endpoint = _Endpoint(
            settings={
                'response_type': (ReleasePipeline,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/release-pipelines',
                'operation_id': 'post_release_pipeline',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'project_key': 'path',
                    'create_release_pipeline_input': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def delete_release_pipeline(
        ...
        **kwargs
        ...
        kwargs['pipeline_key'] = \
            pipeline_key
        return self.delete_release_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def get_all_release_pipelines(
        ...
        **kwargs
        ...
        """Get all release pipelines  # noqa: E501

        Get all release pipelines for a project.  ### Filtering release pipelines  LaunchDarkly supports the following fields for filters:  - `query` is a string that matches against the release pipeline `key`, `name`, and `description`. It is not case sensitive. For example: `?filter=query:examplePipeline`.  - `env` is a string that matches an environment key. For example: `?filter=env:production`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_release_pipelines(project_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_all_release_pipelines_endpoint.call_with_http_info(**kwargs)
    ...
    def get_all_release_progressions_for_release_pipeline(
        ...
        **kwargs
        ...
        """Get release progressions for release pipeline  # noqa: E501

        Get details on the progression of all releases, across all flags, for a release pipeline  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_release_progressions_for_release_pipeline(project_key, pipeline_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pipeline_key'] = \
            pipeline_key
        return self.get_all_release_progressions_for_release_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def get_release_pipeline_by_key(
        ...
        **kwargs
        ...
        """Get release pipeline by key  # noqa: E501

        Get a release pipeline by key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_release_pipeline_by_key(project_key, pipeline_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pipeline_key'] = \
            pipeline_key
        return self.get_release_pipeline_by_key_endpoint.call_with_http_info(**kwargs)

    def patch_release_pipeline(
        self,
        project_key,
        pipeline_key,
        **kwargs
    ):
        """Update a release pipeline  # noqa: E501

        Updates a release pipeline. Updating a release pipeline uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_release_pipeline(project_key, pipeline_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pipeline_key'] = \
            pipeline_key
        return self.patch_release_pipeline_endpoint.call_with_http_info(**kwargs)
    ...
    def post_release_pipeline(
        ...
        **kwargs
        ...
        """Create a release pipeline  # noqa: E501

        Creates a new release pipeline.  The first release pipeline you create is automatically set as the default release pipeline for your project. To change the default release pipeline, use the [Update project](/tag/Projects#operation/patchProject) API to set the `defaultReleasePipelineKey`.  You can create up to 20 release pipelines per project.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_release_pipeline(project_key, create_release_pipeline_input, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        kwargs['create_release_pipeline_input'] = \
            create_release_pipeline_input
        return self.post_release_pipeline_endpoint.call_with_http_info(**kwargs)
