    ...
    def __init__(self, api_client=None):
        ...
        def __delete_metric(
            ...
            **kwargs
            ...
            >>> thread = api.delete_metric(project_key, key, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_metric = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/metrics/{projectKey}/{key}',
        ...
        def __get_metric(
            ...
            **kwargs
            ...
            Get information for a single metric from the specific project.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_metric(project_key, key, async_req=True)
            >>> result = thread.get()
        ...
        def __get_metrics(
            ...
            **kwargs
            ...
            Get a list of all metrics for the specified project.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __patch_metric(
            ...
            **kwargs
            ...
            >>> thread = api.patch_metric(project_key, key, json_patch, async_req=True)
            >>> result = thread.get()
        ...
        def __post_metric(
            ...
            **kwargs
            ...
            Create a new metric in the specified project. Note that the expected POST body differs depending on the specified kind property.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
