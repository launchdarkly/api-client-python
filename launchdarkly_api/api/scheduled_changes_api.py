...
class ScheduledChangesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_flag_config_scheduled_changes(
            self,
            project_key,
            feature_flag_key,
            environment_key,
        ...
        self.delete_flag_config_scheduled_changes = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
            ...
            callable=__delete_flag_config_scheduled_changes
        )

        def __get_feature_flag_scheduled_change(
            self,
            project_key,
            feature_flag_key,
            environment_key,
        ...
        self.get_feature_flag_scheduled_change = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_feature_flag_scheduled_change
        )

        def __get_flag_config_scheduled_changes(
            self,
            project_key,
            feature_flag_key,
            environment_key,
        ...
        self.get_flag_config_scheduled_changes = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_flag_config_scheduled_changes
        )

        def __patch_flag_config_scheduled_change(
            self,
            project_key,
            feature_flag_key,
            environment_key,
            ...
            **kwargs
            ...
            Update a scheduled change, overriding existing instructions with the new ones.<br /><br />Requires a semantic patch representation of the desired changes to the resource. To learn more about semantic patches, read [Updates](/#section/Updates/Updates-via-semantic-patches)  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.patch_flag_config_scheduled_change = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChange,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__patch_flag_config_scheduled_change
        )

        def __post_flag_config_scheduled_changes(
            self,
            project_key,
            feature_flag_key,
            environment_key,
        ...
        self.post_flag_config_scheduled_changes = _Endpoint(
            settings={
                'response_type': (FeatureFlagScheduledChange,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_flag_config_scheduled_changes
        )
