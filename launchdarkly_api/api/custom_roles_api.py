    ...
    def __init__(self, api_client=None):
        ...
        def __delete_custom_role(
            ...
            **kwargs
            ...
            >>> thread = api.delete_custom_role(key, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_custom_role = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/roles/{key}',
            ...
            callable=__delete_custom_role
        )

        def __get_custom_role(
            self,
            key,
            **kwargs
        ):
            ...
            >>> thread = api.get_custom_role(key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_custom_role = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_custom_role
        )

        def __get_custom_roles(
            self,
            **kwargs
        ):
        ...
        self.get_custom_roles = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_custom_roles
        )

        def __patch_custom_role(
            self,
            key,
            patch_with_comment,
            **kwargs
            ...
            Update a single custom role. The request must be a valid JSON Patch document describing the changes to be made to the custom role.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.patch_custom_role(key, patch_with_comment, async_req=True)
            >>> result = thread.get()
        ...
        self.patch_custom_role = _Endpoint(
            settings={
