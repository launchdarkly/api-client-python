    ...
    def __init__(self, api_client=None):
        ...
        def __delete_approval_request(
            ...
            **kwargs
            ...
            >>> thread = api.delete_approval_request(project_key, feature_flag_key, environment_key, id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_approval_request = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
            ...
            callable=__delete_approval_request
        )
        ...
        def __get_approval(
            ...
            **kwargs
            ...
            >>> thread = api.get_approval(project_key, feature_flag_key, environment_key, id, async_req=True)
            >>> result = thread.get()
        ...
        def __get_approvals(
            ...
            **kwargs
            ...
            """List all approval requests  # noqa: E501

            Get all approval requests for a feature flag  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_approvals(project_key, feature_flag_key, environment_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_approvals = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_approvals
        )

        def __post_approval_request(
            self,
            project_key,
            feature_flag_key,
            environment_key,
            ...
            **kwargs
            ...
            >>> thread = api.post_approval_request(project_key, feature_flag_key, environment_key, create_flag_config_approval_request_request, async_req=True)
            >>> result = thread.get()
        ...
        self.post_approval_request = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_approval_request
        )

        def __post_approval_request_apply_request(
            self,
            project_key,
            feature_flag_key,
            environment_key,
            ...
            **kwargs
            ...
            Apply approval request by either approving or declining changes.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.post_approval_request_apply_request(project_key, feature_flag_key, environment_key, id, post_approval_request_apply_request, async_req=True)
            >>> result = thread.get()
        ...
        self.post_approval_request_apply_request = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ...
                'operation_id': 'post_approval_request_apply_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__post_approval_request_apply_request
        )

        def __post_approval_request_review(
            self,
            project_key,
            feature_flag_key,
            environment_key,
            ...
            **kwargs
            ...
            Review approval request by either approving or declining changes.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.post_approval_request_review(project_key, feature_flag_key, environment_key, id, post_approval_request_review_request, async_req=True)
            >>> result = thread.get()
        ...
        self.post_approval_request_review = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_approval_request_review
        )

        def __post_flag_copy_config_approval_request(
            self,
            project_key,
            feature_flag_key,
            environment_key,
        ...
        self.post_flag_copy_config_approval_request = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_flag_copy_config_approval_request
        )
