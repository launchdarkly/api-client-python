...
class ApprovalsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_approval_endpoint = _Endpoint(
            settings={
        ...
        self.post_approval_request_apply_request_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
    ...
    def get_approval(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.get_approval_endpoint.call_with_http_info(**kwargs)
    ...
    def post_approval_request_apply_request(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        **kwargs
        ...
        kwargs['post_approval_request_apply_request'] = \
            post_approval_request_apply_request
        return self.post_approval_request_apply_request_endpoint.call_with_http_info(**kwargs)
