    ...
    def __init__(self, api_client=None):
        ...
        def __delete_team(
            ...
            **kwargs
            ...
            >>> thread = api.delete_team(key, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_team = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/teams/{key}',
        ...
        def __get_team(
            ...
            **kwargs
            ...
            >>> thread = api.get_team(key, async_req=True)
            >>> result = thread.get()
        ...
        def __patch_team(
            ...
            **kwargs
            ...
            >>> thread = api.patch_team(key, team_patch_input, async_req=True)
            >>> result = thread.get()
