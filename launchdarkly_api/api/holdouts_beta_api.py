...
class HoldoutsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_holdouts_endpoint = _Endpoint(
            settings={
                'response_type': (HoldoutsCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts',
                'operation_id': 'get_all_holdouts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_holdout_endpoint = _Endpoint(
            settings={
                'response_type': (HoldoutDetailRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}',
                'operation_id': 'get_holdout',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_holdout_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (HoldoutRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId}',
                'operation_id': 'get_holdout_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_holdout_endpoint = _Endpoint(
            settings={
                'response_type': (HoldoutRep,),
                'auth': [
                    'ApiKey'
        ...
        self.post_holdout_endpoint = _Endpoint(
            settings={
                'response_type': (HoldoutRep,),
                'auth': [
                    'ApiKey'
    ...
    def get_all_holdouts(
        ...
        **kwargs
        ...
        """Get all holdouts  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_holdouts(project_key, environment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_all_holdouts_endpoint.call_with_http_info(**kwargs)
    ...
    def get_holdout(
        ...
        **kwargs
        ...
        kwargs['holdout_key'] = \
            holdout_key
        return self.get_holdout_endpoint.call_with_http_info(**kwargs)
    ...
    def get_holdout_by_id(
        ...
        **kwargs
        ...
        """Get Holdout by Id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_holdout_by_id(project_key, environment_key, holdout_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['holdout_id'] = \
            holdout_id
        return self.get_holdout_by_id_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_holdout(
        ...
        **kwargs
        ...
        kwargs['holdout_key'] = \
            holdout_key
        kwargs['holdout_patch_input'] = \
            holdout_patch_input
        return self.patch_holdout_endpoint.call_with_http_info(**kwargs)
    ...
    def post_holdout(
        ...
        **kwargs
        ...
        """Create holdout  # noqa: E501

        Create a new holdout in the specified project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_holdout(project_key, environment_key, holdout_post_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_key'] = \
            environment_key
        kwargs['holdout_post_request'] = \
            holdout_post_request
        return self.post_holdout_endpoint.call_with_http_info(**kwargs)
