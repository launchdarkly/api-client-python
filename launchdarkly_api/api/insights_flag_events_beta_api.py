...
class InsightsFlagEventsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_flag_events_endpoint = _Endpoint(
            settings={
                'response_type': (FlagEventCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/flag-events',
                'operation_id': 'get_flag_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_flag_events(
        ...
        **kwargs
        ...
        kwargs['environment_key'] = \
            environment_key
        return self.get_flag_events_endpoint.call_with_http_info(**kwargs)
