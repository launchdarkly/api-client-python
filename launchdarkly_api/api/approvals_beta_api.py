...
class ApprovalsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.patch_approval_request_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'patch_approval_request',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.patch_flag_config_approval_request_endpoint = _Endpoint(
            settings={
                'response_type': (FlagConfigApprovalRequestResponse,),
                'auth': [
                    'ApiKey'
                ...
                'operation_id': 'patch_flag_config_approval_request',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def patch_approval_request(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.patch_approval_request_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_flag_config_approval_request(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.patch_flag_config_approval_request_endpoint.call_with_http_info(**kwargs)
