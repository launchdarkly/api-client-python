...
class ApprovalsBetaApi:
    ...
    @validate_call
    def get_approval_request_settings(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: Annotated[Optional[StrictStr], Field(description="An environment key filter to apply to the approval request settings.")] = None,
        resource_kind: Annotated[Optional[StrictStr], Field(description="A resource kind filter to apply to the approval request settings.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of fields to expand in the response. Options include 'default' and 'strict'.")] = None,
    ...
    ) -> Dict[str, ApprovalRequestSettingWithEnvs]:
        ...
        :param environment_key: An environment key filter to apply to the approval request settings.
        :type environment_key: str
        :param resource_kind: A resource kind filter to apply to the approval request settings.
        :type resource_kind: str
        :param expand: A comma-separated list of fields to expand in the response. Options include 'default' and 'strict'.
        :type expand: str
        ...
        _param = self._get_approval_request_settings_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Dict[str, ApprovalRequestSettingWithEnvs]",
            '400': "Error",
            '403': "Error",
            '404': "Error",
            '500': "Error",
    ...
    @validate_call
    def get_approval_request_settings_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: Annotated[Optional[StrictStr], Field(description="An environment key filter to apply to the approval request settings.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, ApprovalRequestSettingWithEnvs]]:
        """Get approval request settings
    ...
    @validate_call
    def get_approval_request_settings_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        environment_key: Annotated[Optional[StrictStr], Field(description="An environment key filter to apply to the approval request settings.")] = None,
    ...
    def _get_approval_request_settings_serialize(
        self,
        ld_api_version,
        project_key,
        environment_key,
        ...
        if resource_kind is not None:
            ...
            _query_params.append(('resourceKind', resource_kind))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/approval-requests/projects/{projectKey}/settings',
    ...
    def patch_approval_request(
        ...
        approval_request_patch_input: ApprovalRequestPatchInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param approval_request_patch_input: (required)
        :type approval_request_patch_input: ApprovalRequestPatchInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_approval_request_serialize(
            id=id,
            approval_request_patch_input=approval_request_patch_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _patch_approval_request_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if approval_request_patch_input is not None:
            _body_params = approval_request_patch_input
    ...
    @validate_call
    def patch_approval_request_settings(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        approval_request_settings_patch: Annotated[Optional[ApprovalRequestSettingsPatch], Field(description="Approval request settings to update")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: (required)
        :type project_key: str
        :param approval_request_settings_patch: Approval request settings to update
        :type approval_request_settings_patch: ApprovalRequestSettingsPatch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_approval_request_settings_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            approval_request_settings_patch=approval_request_settings_patch,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_approval_request_settings_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        approval_request_settings_patch: Annotated[Optional[ApprovalRequestSettingsPatch], Field(description="Approval request settings to update")] = None,
    ...
    @validate_call
    def patch_approval_request_settings_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: StrictStr,
        approval_request_settings_patch: Annotated[Optional[ApprovalRequestSettingsPatch], Field(description="Approval request settings to update")] = None,
    ...
    def _patch_approval_request_settings_serialize(
        self,
        ld_api_version,
        project_key,
        approval_request_settings_patch,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if approval_request_settings_patch is not None:
            _body_params = approval_request_settings_patch
