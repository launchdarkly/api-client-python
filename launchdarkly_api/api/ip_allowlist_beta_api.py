...
class IPAllowlistBetaApi:
    ...
    @validate_call
    def create_ip_allowlist_entry(
        self,
        create_ip_allowlist_entry_request: CreateIpAllowlistEntryRequest,
        ...
        :param create_ip_allowlist_entry_request: (required)
        :type create_ip_allowlist_entry_request: CreateIpAllowlistEntryRequest
        ...
        _param = self._create_ip_allowlist_entry_serialize(
            create_ip_allowlist_entry_request=create_ip_allowlist_entry_request,
    ...
    @validate_call
    def create_ip_allowlist_entry_with_http_info(
        self,
        create_ip_allowlist_entry_request: CreateIpAllowlistEntryRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_ip_allowlist_entry_without_preload_content(
        self,
        create_ip_allowlist_entry_request: CreateIpAllowlistEntryRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_ip_allowlist_entry_serialize(
        self,
        create_ip_allowlist_entry_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_ip_allowlist_entry_request is not None:
            _body_params = create_ip_allowlist_entry_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/account/ip-allowlist',
    ...
    def delete_ip_allowlist_entry(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_ip_allowlist_entry_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_ip_allowlist_entry_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_ip_allowlist_entry_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        _request_timeout: Union[
            None,
    ...
    def _delete_ip_allowlist_entry_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/account/ip-allowlist/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_ip_allowlist(
        self,
        search: Annotated[Optional[StrictStr], Field(description="A case-insensitive substring to filter entries by. Matches against the IP address or CIDR block and the description.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The number of entries to skip. Used for pagination.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param search: A case-insensitive substring to filter entries by. Matches against the IP address or CIDR block and the description.
        :type search: str
        :param limit: The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.
        :type limit: int
        :param offset: The number of entries to skip. Used for pagination.
        :type offset: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_ip_allowlist_serialize(
            search=search,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_ip_allowlist_with_http_info(
        self,
        search: Annotated[Optional[StrictStr], Field(description="A case-insensitive substring to filter entries by. Matches against the IP address or CIDR block and the description.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The number of entries to skip. Used for pagination.")] = None,
    ...
    @validate_call
    def get_ip_allowlist_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="A case-insensitive substring to filter entries by. Matches against the IP address or CIDR block and the description.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The number of entries to skip. Used for pagination.")] = None,
    ...
    def _get_ip_allowlist_serialize(
        self,
        search,
        limit,
        offset,
    ...
    @validate_call
    def patch_ip_allowlist_config(
        self,
        patch_ip_allowlist_config_request: PatchIpAllowlistConfigRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param patch_ip_allowlist_config_request: (required)
        :type patch_ip_allowlist_config_request: PatchIpAllowlistConfigRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_ip_allowlist_config_serialize(
            patch_ip_allowlist_config_request=patch_ip_allowlist_config_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_ip_allowlist_config_with_http_info(
        self,
        patch_ip_allowlist_config_request: PatchIpAllowlistConfigRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_ip_allowlist_config_without_preload_content(
        self,
        patch_ip_allowlist_config_request: PatchIpAllowlistConfigRequest,
        _request_timeout: Union[
            None,
    ...
    def _patch_ip_allowlist_config_serialize(
        self,
        patch_ip_allowlist_config_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if patch_ip_allowlist_config_request is not None:
            _body_params = patch_ip_allowlist_config_request
    ...
    @validate_call
    def patch_ip_allowlist_entry(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        patch_ip_allowlist_entry_request: PatchIpAllowlistEntryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Unique identifier for the allowlist entry (required)
        :type id: str
        :param patch_ip_allowlist_entry_request: (required)
        :type patch_ip_allowlist_entry_request: PatchIpAllowlistEntryRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_ip_allowlist_entry_serialize(
            id=id,
            patch_ip_allowlist_entry_request=patch_ip_allowlist_entry_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_ip_allowlist_entry_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        patch_ip_allowlist_entry_request: PatchIpAllowlistEntryRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_ip_allowlist_entry_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the allowlist entry")],
        patch_ip_allowlist_entry_request: PatchIpAllowlistEntryRequest,
        _request_timeout: Union[
    ...
    def _patch_ip_allowlist_entry_serialize(
        self,
        id,
        patch_ip_allowlist_entry_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if patch_ip_allowlist_entry_request is not None:
            _body_params = patch_ip_allowlist_entry_request
