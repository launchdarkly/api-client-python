...
class CodeReferencesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_branches = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
        ...
        self.get_branches = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_branches
        )

        def __get_extinctions(
            self,
            **kwargs
        ):
            """List extinctions  # noqa: E501

            Get a list of all extinctions.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_extinctions = _Endpoint(
            settings={
        ...
        self.get_repositories = _Endpoint(
            settings={
        ...
        self.get_root_statistic = _Endpoint(
            settings={
        ...
        def __get_statistics(
            ...
            **kwargs
            ...
            """Get number of code references for flags  # noqa: E501

            Get the number of code references across repositories for all flags in your project that have code references in the default branch (for example: master). You can optionally include the `flagKey` query parameter to get the number of code references across repositories for a single flag. This endpoint returns the number of times your flag keys are referenced in your repositories. You can filter to a single flag with by passing in a flag key.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_statistics(proj_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_statistics = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/code-refs/statistics/{projKey}',
        ...
        self.patch_repository = _Endpoint(
            settings={
                'response_type': (RepositoryRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__patch_repository
        )

        def __post_extinction(
            self,
            repo,
            branch,
            extinction_rep,
        ...
        self.post_extinction = _Endpoint(
            ...
            api_client=api_client,
            callable=__post_extinction
        )

        def __post_repository(
            self,
            repository_post,
            **kwargs
        ):
        ...
        def __put_branch(
            ...
            **kwargs
            ...
            Create a new branch if it doesn't exist, or updates the branch if it already exists.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
