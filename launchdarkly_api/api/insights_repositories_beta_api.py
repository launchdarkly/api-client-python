...
class InsightsRepositoriesBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.associate_repositories_and_projects_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsRepositoryProjectCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/repositories/projects',
                'operation_id': 'associate_repositories_and_projects',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'insights_repository_project_mappings': 'body',
                },
        ...
        self.delete_repository_project_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}',
                'operation_id': 'delete_repository_project',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_insights_repositories_endpoint = _Endpoint(
            settings={
                'response_type': (InsightsRepositoryCollection,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/repositories',
                'operation_id': 'get_insights_repositories',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def associate_repositories_and_projects(
        ...
        **kwargs
        ...
        """Associate repositories with projects  # noqa: E501

        Associate repositories with projects  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.associate_repositories_and_projects(insights_repository_project_mappings, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['insights_repository_project_mappings'] = \
            insights_repository_project_mappings
        return self.associate_repositories_and_projects_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_repository_project(
        ...
        **kwargs
        ...
        """Remove repository project association  # noqa: E501

        Remove repository project association  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_repository_project(repository_key, project_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['repository_key'] = \
            repository_key
        kwargs['project_key'] = \
            project_key
        return self.delete_repository_project_endpoint.call_with_http_info(**kwargs)
    ...
    def get_insights_repositories(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_insights_repositories_endpoint.call_with_http_info(**kwargs)
