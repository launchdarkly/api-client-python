    ...
    def __init__(self, api_client=None):
        ...
        def __delete_user(
            ...
            **kwargs
            ...
            >>> thread = api.delete_user(proj_key, env_key, key, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_user = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/users/{projKey}/{envKey}/{key}',
        ...
        def __get_search_users(
            ...
            **kwargs
            ...
            >>> thread = api.get_search_users(proj_key, env_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_search_users = _Endpoint(
            settings={
                'response_type': (Users,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/user-search/{projKey}/{envKey}',
        ...
        def __get_user(
            ...
            **kwargs
            ...
            >>> thread = api.get_user(proj_key, env_key, key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_users = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/users/{projKey}/{envKey}',
