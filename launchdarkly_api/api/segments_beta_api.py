...
class SegmentsBetaApi(object):
    ...
    def create_big_segment_export(
        ...
        **kwargs
        ...
        Starts a new export process for a Big Segment. This is an export for a list-based segment that can include more than 15,000 entries.  # noqa: E501
    ...
    def get_big_segment_export(
        ...
        **kwargs
        ...
        Returns information about a Big Segment export process. This is the export of a list-based segment that can include more than 15,000 entries.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
