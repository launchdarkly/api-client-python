...
class ApplicationsBetaApi:
    ...
    def get_application_versions(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `key`, `name`, `supported`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](https://launchdarkly.com/docs/api/applications-beta#filtering-applications-and-application-versions).")] = None,
        ...
        :param application_key: The application key (required)
        :type application_key: str
        :param filter: Accepts filter by `key`, `name`, `supported`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](https://launchdarkly.com/docs/api/applications-beta#filtering-applications-and-application-versions).
        :type filter: str
    ...
    def get_applications(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `key`, `name`, `kind`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](https://launchdarkly.com/docs/api/applications-beta#filtering-applications-and-application-versions).")] = None,
        ...
        :param filter: Accepts filter by `key`, `name`, `kind`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](https://launchdarkly.com/docs/api/applications-beta#filtering-applications-and-application-versions).
        :type filter: str
