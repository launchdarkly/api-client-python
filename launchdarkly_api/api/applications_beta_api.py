...
from launchdarkly_api.model.create_application_input import CreateApplicationInput
from launchdarkly_api.model.create_application_version_input import CreateApplicationVersionInput
...
class ApplicationsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_application_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/applications/{applicationKey}',
        ...
        self.delete_application_version_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/applications/{applicationKey}/versions/{versionKey}',
                'operation_id': 'delete_application_version',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_application_versions_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationVersionsCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/applications/{applicationKey}/versions',
                'operation_id': 'get_application_versions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_applications_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/applications',
        ...
        self.patch_application_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/applications/{applicationKey}',
                'operation_id': 'patch_application',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.patch_application_version_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationVersionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/applications/{applicationKey}/versions/{versionKey}',
                'operation_id': 'patch_application_version',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.post_application_version_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationVersionRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/applications/{applicationKey}/versions',
                'operation_id': 'post_application_version',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'application_key',
                    'create_application_version_input',
                ],
                'required': [
                    'application_key',
                    'create_application_version_input',
            ...
            root_map={
                ...
                'location_map': {
                    'application_key': 'path',
                    'create_application_version_input': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_application(
        ...
        **kwargs
        ...
        >>> thread = api.create_application(create_application_input, async_req=True)
        >>> result = thread.get()

        Args:
            create_application_input (CreateApplicationInput):
        ...
        kwargs['create_application_input'] = \
            create_application_input
    ...
    def delete_application(
        ...
        **kwargs
        ...
        >>> thread = api.delete_application(application_key, async_req=True)
        >>> result = thread.get()
    ...
    def delete_application_version(
        ...
        **kwargs
        ...
        """Delete application version  # noqa: E501

        Delete an application version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_application_version(application_key, version_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version_key'] = \
            version_key
        return self.delete_application_version_endpoint.call_with_http_info(**kwargs)
    ...
    def get_application_versions(
        ...
        **kwargs
        ...
        """Get application versions by application key  # noqa: E501

        Get a list of versions for a specific application in an account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_application_versions(application_key, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            filter (str): Accepts filter by `key`, `name`, `supported`, and `autoAdded`. Example: `filter=key equals 'test-key'`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).. [optional]
        ...
        kwargs['application_key'] = \
            application_key
        return self.get_application_versions_endpoint.call_with_http_info(**kwargs)
    ...
    def get_applications(
        ...
        **kwargs
        ...
        Keyword Args:
            filter (str): Accepts filter by `key`, `name`, `kind`, and `autoAdded`. Example: `filter=kind anyOf ['mobile', 'server'],key equals 'test-key'`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).. [optional]
    ...
    def patch_application(
        ...
        **kwargs
        ...
        Update an application. You can update the `description` and `kind` fields. Requires a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the application. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_application(application_key, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_application_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_application_version(
        ...
        **kwargs
        ...
        """Update application version  # noqa: E501

        Update an application version. You can update the `supported` field. Requires a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the application version. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_application_version(application_key, version_key, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_application_version_endpoint.call_with_http_info(**kwargs)

    def post_application_version(
        self,
        application_key,
        create_application_version_input,
        **kwargs
    ):
        """Post application version  # noqa: E501

        Create an application version  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_application_version(application_key, create_application_version_input, async_req=True)
        >>> result = thread.get()

        Args:
            application_key (str): The application key
            create_application_version_input (CreateApplicationVersionInput):
        ...
        kwargs['application_key'] = \
            application_key
        kwargs['create_application_version_input'] = \
            create_application_version_input
        return self.post_application_version_endpoint.call_with_http_info(**kwargs)
