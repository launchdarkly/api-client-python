...
class AIConfigsApi:
    ...
    @validate_call
    def list_agent_optimization_runs(
        self,
        ...
        _param = self._list_agent_optimization_runs_serialize(
    ...
    @validate_call
    def list_agent_optimization_runs_with_http_info(
        self,
        project_key: StrictStr,
        optimization_key: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="The number of resources to return.")] = None,
    ...
    @validate_call
    def list_agent_optimization_runs_without_preload_content(
        self,
        project_key: StrictStr,
        optimization_key: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="The number of resources to return.")] = None,
    ...
    def _list_agent_optimization_runs_serialize(
        self,
        project_key,
        optimization_key,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/runs',
    ...
    def list_ai_tool_references(
        ...
        _param = self._list_ai_tool_references_serialize(
            project_key=project_key,
            tool_key=tool_key,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def list_ai_tool_references_with_http_info(
        self,
        project_key: StrictStr,
        tool_key: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="The number of resources to return.")] = None,
    ...
    @validate_call
    def list_ai_tool_references_without_preload_content(
        self,
        project_key: StrictStr,
        tool_key: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="The number of resources to return.")] = None,
    ...
    def _list_ai_tool_references_serialize(
        self,
        project_key,
        tool_key,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/ai-tools/{toolKey}/references',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
