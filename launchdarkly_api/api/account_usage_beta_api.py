...
class AccountUsageBetaApi:
    ...
    def get_ai_runs_usage(
        ...
        group_by: Annotated[Optional[StrictStr], Field(description="If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `sdkName`, `sdkVersion`, `sdkType`.")] = None,
        ...
        :type sdk_type: str
        :param group_by: If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `sdkName`, `sdkVersion`, `sdkType`.
        :type group_by: str
        ...
        _param = self._get_ai_runs_usage_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def get_ai_runs_usage_with_http_info(
        self,
        var_from: Annotated[Optional[StrictStr], Field(description="The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
    ...
    @validate_call
    def get_ai_runs_usage_without_preload_content(
        self,
        var_from: Annotated[Optional[StrictStr], Field(description="The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
    ...
    def _get_ai_runs_usage_serialize(
        self,
        var_from,
        to,
        project_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/usage/ai-runs',
    ...
    def get_observability_metrics_usage(
        ...
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
        granularity: Annotated[Optional[StrictStr], Field(description="Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `hourly`, `daily`, and `monthly`; **average** supports `hourly`, `daily`, and `monthly`.")] = None,
        aggregation_type: Annotated[Optional[StrictStr], Field(description="Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `average`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: A project key to filter results by. Can be specified multiple times, one query parameter per project key.
        :type project_key: str
        :param granularity: Specifies the data granularity. Defaults to `daily`. Valid values depend on `aggregationType`: **month_to_date** supports `hourly`, `daily`, and `monthly`; **average** supports `hourly`, `daily`, and `monthly`.
        :type granularity: str
        :param aggregation_type: Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `average`.
        :type aggregation_type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def get_sdk_all_versions(
        self,
        environment_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific environment ID.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific project ID.")] = None,
        sdk_name: Annotated[Optional[StrictStr], Field(description="Filter to a specific SDK name.")] = None,
        sdk_type: Annotated[Optional[StrictStr], Field(description="Filter to a specific SDK type (for example, 'server', 'browser', 'mobile').")] = None,
        sdk_app_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific SDK application ID.")] = None,
        connection_type: Annotated[Optional[StrictStr], Field(description="Filter to a specific connection type (for example, 'direct', 'proxy').")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_id: Filter to a specific environment ID.
        :type environment_id: str
        :param project_id: Filter to a specific project ID.
        :type project_id: str
        :param sdk_name: Filter to a specific SDK name.
        :type sdk_name: str
        :param sdk_type: Filter to a specific SDK type (for example, 'server', 'browser', 'mobile').
        :type sdk_type: str
        :param sdk_app_id: Filter to a specific SDK application ID.
        :type sdk_app_id: str
        :param connection_type: Filter to a specific connection type (for example, 'direct', 'proxy').
        ...
        _param = self._get_sdk_all_versions_serialize(
    ...
    @validate_call
    def get_sdk_all_versions_with_http_info(
        self,
        environment_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific environment ID.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific project ID.")] = None,
        sdk_name: Annotated[Optional[StrictStr], Field(description="Filter to a specific SDK name.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SdkVersionDetailsRep]]:
        """Get usage details for all SDK versions
    ...
    @validate_call
    def get_sdk_all_versions_without_preload_content(
        self,
        environment_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific environment ID.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Filter to a specific project ID.")] = None,
        sdk_name: Annotated[Optional[StrictStr], Field(description="Filter to a specific SDK name.")] = None,
    ...
    def _get_sdk_all_versions_serialize(
        self,
        environment_id,
        project_id,
        sdk_name,
        ...
        if sdk_app_id is not None:
            
            _query_params.append(('sdkAppId', sdk_app_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/usage/sdk-versions/all',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_sdk_versions_details(
        ...
        _param = self._get_sdk_versions_details_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_sdk_versions_details_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_sdk_versions_details_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_sdk_versions_details_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/usage/sdk-versions/details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_service_connections_usage(
        ...
        sdk_version: Annotated[Optional[StrictStr], Field(description="An SDK version to filter results by. Can be specified multiple times, one query parameter per SDK version.")] = None,
        sdk_type: Annotated[Optional[StrictStr], Field(description="An SDK type to filter results by. Can be specified multiple times, one query parameter per SDK type.")] = None,
        sdk_app_id: Annotated[Optional[StrictStr], Field(description="An SDK app ID to filter results by. Can be specified multiple times, one query parameter per SDK app ID.")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `connectionType`, `relayVersion`, `sdkName`, `sdkVersion`, `sdkType`, `sdkAppId`.")] = None,
        aggregation_type: Annotated[Optional[StrictStr], Field(description="Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.")] = None,
        granularity: Annotated[Optional[StrictStr], Field(description="Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param sdk_type: An SDK type to filter results by. Can be specified multiple times, one query parameter per SDK type.
        :type sdk_type: str
        :param sdk_app_id: An SDK app ID to filter results by. Can be specified multiple times, one query parameter per SDK app ID.
        :type sdk_app_id: str
        :param group_by: If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `connectionType`, `relayVersion`, `sdkName`, `sdkVersion`, `sdkType`, `sdkAppId`.
        :type group_by: str
        :param aggregation_type: Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
        :type aggregation_type: str
        :param granularity: Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
    ...
    @validate_call
    def get_warehouse_export_usage(
        self,
        var_from: Annotated[Optional[StrictStr], Field(description="The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
        environment_key: Annotated[Optional[StrictStr], Field(description="An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.")] = None,
        destination: Annotated[Optional[StrictStr], Field(description="A destination kind to filter results by. Can be specified multiple times, one query parameter per destination kind.<br/>Valid values: `snowflake-v2`, `databricks`, `bigquery`, `redshift`, `clickhouse`.")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `destination`.")] = None,
        aggregation_type: Annotated[Optional[StrictStr], Field(description="Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.")] = None,
        granularity: Annotated[Optional[StrictStr], Field(description="Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param environment_key: An environment key to filter results by. If specified, exactly one `projectKey` must be provided. Can be specified multiple times, one query parameter per environment key.
        :type environment_key: str
        :param destination: A destination kind to filter results by. Can be specified multiple times, one query parameter per destination kind.<br/>Valid values: `snowflake-v2`, `databricks`, `bigquery`, `redshift`, `clickhouse`.
        :type destination: str
        :param group_by: If specified, returns data for each distinct value of the given field. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension.<br/>Valid values: `projectId`, `environmentId`, `destination`.
        :type group_by: str
        :param aggregation_type: Specifies the aggregation method. Defaults to `month_to_date`.<br/>Valid values: `month_to_date`, `incremental`.
        :type aggregation_type: str
        :param granularity: Specifies the data granularity. Defaults to `daily`. `monthly` granularity is only supported with the **month_to_date** aggregation type.<br/>Valid values: `daily`, `hourly`, `monthly`.
        ...
        _param = self._get_warehouse_export_usage_serialize(
            var_from=var_from,
            to=to,
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def get_warehouse_export_usage_with_http_info(
        self,
        var_from: Annotated[Optional[StrictStr], Field(description="The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
    ...
    @validate_call
    def get_warehouse_export_usage_without_preload_content(
        self,
        var_from: Annotated[Optional[StrictStr], Field(description="The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.")] = None,
        to: Annotated[Optional[StrictStr], Field(description="The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.")] = None,
        project_key: Annotated[Optional[StrictStr], Field(description="A project key to filter results by. Can be specified multiple times, one query parameter per project key.")] = None,
    ...
    def _get_warehouse_export_usage_serialize(
        self,
        var_from,
        to,
        project_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/usage/warehouse-export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
