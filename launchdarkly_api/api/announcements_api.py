...
class AnnouncementsApi:
    ...
    @validate_call
    def create_announcement_public(
        self,
        create_announcement_body: Annotated[CreateAnnouncementBody, Field(description="Announcement request body")],
        ...
        :param create_announcement_body: Announcement request body (required)
        :type create_announcement_body: CreateAnnouncementBody
        ...
        _param = self._create_announcement_public_serialize(
            create_announcement_body=create_announcement_body,
    ...
    @validate_call
    def create_announcement_public_with_http_info(
        self,
        create_announcement_body: Annotated[CreateAnnouncementBody, Field(description="Announcement request body")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_announcement_public_without_preload_content(
        self,
        create_announcement_body: Annotated[CreateAnnouncementBody, Field(description="Announcement request body")],
        _request_timeout: Union[
            None,
    ...
    def _create_announcement_public_serialize(
        self,
        create_announcement_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_announcement_body is not None:
            _body_params = create_announcement_body
    ...
    @validate_call
    def delete_announcement_public(
        self,
        announcement_id: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_announcement_public_serialize(
    ...
    @validate_call
    def delete_announcement_public_with_http_info(
        self,
        announcement_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_announcement_public_without_preload_content(
        self,
        announcement_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_announcement_public_serialize(
        self,
        announcement_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/announcements/{announcementId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_announcements_public(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Filter announcements by status.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of announcements to return.")] = None,
        ...
        :param status: Filter announcements by status.
        :type status: str
        ...
        _param = self._get_announcements_public_serialize(
            status=status,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAnnouncementsPublic200Response",
            '400': "Error",
            '403': "Error",
            '404': "Error",
            '429': "Error",
    ...
    @validate_call
    def get_announcements_public_with_http_info(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Filter announcements by status.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of announcements to return.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    @validate_call
    def get_announcements_public_without_preload_content(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Filter announcements by status.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of announcements to return.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    def _get_announcements_public_serialize(
        self,
        status,
        limit,
        offset,
    ...
    @validate_call
    def update_announcement_public(
        self,
        announcement_id: StrictStr,
        announcement_patch_operation: Annotated[List[AnnouncementPatchOperation], Field(description="Update announcement request body")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param announcement_id: (required)
        :type announcement_id: str
        :param announcement_patch_operation: Update announcement request body (required)
        :type announcement_patch_operation: List[AnnouncementPatchOperation]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_announcement_public_serialize(
            announcement_id=announcement_id,
            announcement_patch_operation=announcement_patch_operation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_announcement_public_with_http_info(
        self,
        announcement_id: StrictStr,
        announcement_patch_operation: Annotated[List[AnnouncementPatchOperation], Field(description="Update announcement request body")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_announcement_public_without_preload_content(
        self,
        announcement_id: StrictStr,
        announcement_patch_operation: Annotated[List[AnnouncementPatchOperation], Field(description="Update announcement request body")],
        _request_timeout: Union[
    ...
    def _update_announcement_public_serialize(
        self,
        announcement_id,
        announcement_patch_operation,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if announcement_patch_operation is not None:
            _body_params = announcement_patch_operation
