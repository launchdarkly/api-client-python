...
class LayersBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_layer_endpoint = _Endpoint(
            settings={
                'response_type': (LayerRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/layers',
        ...
        self.get_layers_endpoint = _Endpoint(
            settings={
                'response_type': (LayerCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/layers',
        ...
        self.update_layer_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/layers/{layerKey}',
    ...
    def create_layer(
        ...
        **kwargs
        ...
        """Create layer  # noqa: E501

        Create a layer. Experiments running in the same layer are granted mutually-exclusive traffic.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_layer(project_key, layer_post, async_req=True)
        >>> result = thread.get()
    ...
    def get_layers(
        ...
        **kwargs
        ...
        """Get layers  # noqa: E501

        Get a collection of all layers for a project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_layers(project_key, async_req=True)
        >>> result = thread.get()
