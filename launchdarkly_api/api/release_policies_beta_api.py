...
class ReleasePoliciesBetaApi:
    ...
    def delete_release_policy(
        ...
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
        ...
        :param policy_key: The human-readable key of the release policy (required)
        :type policy_key: str
        ...
        _param = self._delete_release_policy_serialize(
    ...
    @validate_call
    def delete_release_policy_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
    ...
    @validate_call
    def delete_release_policy_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
    ...
    def _delete_release_policy_serialize(
        self,
        ld_api_version,
        project_key,
        policy_key,
        ...
        if policy_key is not None:
            _path_params['policyKey'] = policy_key
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/release-policies/{policyKey}',
    ...
    @validate_call
    def get_release_policies(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        exclude_default: Annotated[Optional[StrictBool], Field(description="When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param exclude_default: When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present.
        ...
        _param = self._get_release_policies_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
    ...
    @validate_call
    def get_release_policies_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        exclude_default: Annotated[Optional[StrictBool], Field(description="When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present.")] = None,
    ...
    @validate_call
    def get_release_policies_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        exclude_default: Annotated[Optional[StrictBool], Field(description="When true, exclude the default release policy from the response. When false or omitted, include the default policy if an environment filter is present.")] = None,
    ...
    def _get_release_policies_serialize(
        self,
        ld_api_version,
        project_key,
        exclude_default,
        ...
        if exclude_default is not None:
            ...
            _query_params.append(('excludeDefault', exclude_default))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/release-policies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_release_policy(
        ...
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The release policy key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param policy_key: The release policy key (required)
        :type policy_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_release_policy_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            policy_key=policy_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_release_policy_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The release policy key")],
    ...
    @validate_call
    def get_release_policy_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The release policy key")],
    ...
    def _get_release_policy_serialize(
        self,
        ld_api_version,
        project_key,
        policy_key,
    ...
    @validate_call
    def post_release_policies_order(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        request_body: Annotated[List[StrictStr], Field(description="Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param request_body: Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project. (required)
        ...
        _param = self._post_release_policies_order_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
    ...
    @validate_call
    def post_release_policies_order_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        request_body: Annotated[List[StrictStr], Field(description="Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project.")],
    ...
    @validate_call
    def post_release_policies_order_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        request_body: Annotated[List[StrictStr], Field(description="Array of release policy keys in the desired rank order (scoped policies only). These keys must include _all_ of the scoped release policies for the project.")],
    ...
    def _post_release_policies_order_serialize(
        self,
        ld_api_version,
        project_key,
        request_body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectKey}/release-policies/order',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_release_policy(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        post_release_policy_request: Annotated[PostReleasePolicyRequest, Field(description="Release policy to create")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param post_release_policy_request: Release policy to create (required)
        :type post_release_policy_request: PostReleasePolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_release_policy_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            post_release_policy_request=post_release_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_release_policy_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        post_release_policy_request: Annotated[PostReleasePolicyRequest, Field(description="Release policy to create")],
    ...
    @validate_call
    def post_release_policy_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        post_release_policy_request: Annotated[PostReleasePolicyRequest, Field(description="Release policy to create")],
    ...
    def _post_release_policy_serialize(
        self,
        ld_api_version,
        project_key,
        post_release_policy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_release_policy_request is not None:
            _body_params = post_release_policy_request
    ...
    def put_release_policy(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
        put_release_policy_request: Annotated[PutReleasePolicyRequest, Field(description="Release policy data to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param policy_key: The human-readable key of the release policy (required)
        :type policy_key: str
        :param put_release_policy_request: Release policy data to update (required)
        :type put_release_policy_request: PutReleasePolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_release_policy_serialize(
            ld_api_version=ld_api_version,
            project_key=project_key,
            policy_key=policy_key,
            put_release_policy_request=put_release_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def put_release_policy_with_http_info(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
    ...
    @validate_call
    def put_release_policy_without_preload_content(
        self,
        ld_api_version: Annotated[StrictStr, Field(description="Version of the endpoint.")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        policy_key: Annotated[StrictStr, Field(description="The human-readable key of the release policy")],
    ...
    def _put_release_policy_serialize(
        self,
        ld_api_version,
        project_key,
        policy_key,
        put_release_policy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if put_release_policy_request is not None:
            _body_params = put_release_policy_request
