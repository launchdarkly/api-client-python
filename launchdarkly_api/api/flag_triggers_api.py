...
class FlagTriggersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_trigger_workflow_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}',
        ...
        self.delete_trigger_workflow_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}/{id}',
    ...
    def create_trigger_workflow(
        ...
        **kwargs
        ...
        Create a new flag trigger. Triggers let you initiate changes to flag targeting remotely using a unique webhook URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_trigger_workflow(proj_key, env_key, flag_key, trigger_post, async_req=True)
        >>> result = thread.get()
    ...
    def delete_trigger_workflow(
        ...
        **kwargs
        ...
        >>> thread = api.delete_trigger_workflow(proj_key, env_key, flag_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def get_trigger_workflow_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.get_trigger_workflow_by_id(proj_key, flag_key, env_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def get_trigger_workflows(
        ...
        **kwargs
        ...
        >>> thread = api.get_trigger_workflows(proj_key, env_key, flag_key, async_req=True)
        >>> result = thread.get()
    ...
    def patch_trigger_workflow(
        ...
        **kwargs
        ...
        Update a flag trigger. The request body must be a valid JSON patch or JSON merge patch document. To learn more, read [Updates](/#section/Overview/Updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_trigger_workflow(proj_key, env_key, flag_key, id, flag_trigger_input, async_req=True)
        >>> result = thread.get()
