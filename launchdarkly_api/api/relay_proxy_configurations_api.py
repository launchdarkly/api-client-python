...
class RelayProxyConfigurationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_relay_auto_config(
            self,
            id,
            **kwargs
        ):
        ...
        self.delete_relay_auto_config = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
            ...
            callable=__delete_relay_auto_config
        )

        def __get_relay_proxy_config(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_relay_proxy_config = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_relay_proxy_config
        )

        def __get_relay_proxy_configs(
            self,
            **kwargs
        ):
        ...
        self.get_relay_proxy_configs = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_relay_proxy_configs
        )

        def __patch_relay_auto_config(
            self,
            id,
            patch_with_comment,
            **kwargs
        ...
        self.patch_relay_auto_config = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__patch_relay_auto_config
        )

        def __post_relay_auto_config(
            self,
        ...
        self.post_relay_auto_config = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__post_relay_auto_config
        )

        def __reset_relay_auto_config(
            self,
            id,
            **kwargs
        ):
        ...
        self.reset_relay_auto_config = _Endpoint(
            settings={
                'response_type': (RelayAutoConfigRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__reset_relay_auto_config
        )
