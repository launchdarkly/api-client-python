    ...
    def __init__(self, api_client=None):
        ...
        def __get_workflows(
            ...
            **kwargs
            ...
            Get workflows from a feature flag  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_workflows = _Endpoint(
            settings={
                'response_type': (CustomWorkflowsListingOutputRep,),
                'auth': [
                    'ApiKey'
                ],
        ...
        def __post_workflow(
            ...
            feature_flag_key,
            environment_key,
            custom_workflow_input_rep,
            **kwargs
        ):
            """Create workflow  # noqa: E501

            Create a workflow for a feature flag  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.post_workflow(project_key, feature_flag_key, environment_key, custom_workflow_input_rep, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['environment_key'] = \
                environment_key
            kwargs['custom_workflow_input_rep'] = \
                custom_workflow_input_rep
            return self.call_with_http_info(**kwargs)

        self.post_workflow = _Endpoint(
            settings={
                'response_type': (CustomWorkflowOutputRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'feature_flag_key': 'path',
                    'environment_key': 'path',
                    'custom_workflow_input_rep': 'body',
                },
                'collection_format_map': {
                }
            },
