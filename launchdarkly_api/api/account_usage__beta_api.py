    ...
    def __init__(self, api_client=None):
        ...
        def __get_evaluations_usage(
            ...
            **kwargs
            ...
            >>> thread = api.get_evaluations_usage(proj_key, env_key, flag_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_evaluations_usage = _Endpoint(
            settings={
                'response_type': (SeriesListRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/usage/evaluations/{projKey}/{envKey}/{flagKey}',
            ...
            callable=__get_evaluations_usage
        )

        def __get_events_usage(
            self,
            type,
            **kwargs
        ):
        ...
        self.get_events_usage = _Endpoint(
            settings={
                'response_type': (SeriesListRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__get_events_usage
        )

        def __get_mau_sdks_by_type(
            self,
            **kwargs
        ):
            """Get MAU SDKs by type  # noqa: E501

            Get a list of SDKs. These are all of the SDKs that have connected to LaunchDarkly by monthly active users (MAU) in the requested time period.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_mau_sdks_by_type = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_mau_sdks_by_type
        )
        ...
        def __get_mau_usage(
            ...
            **kwargs
            ...
            Get a time-series array of the number of monthly active users (MAU) seen by LaunchDarkly from your account. The granularity is always daily.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_mau_usage = _Endpoint(
            ...
            api_client=api_client,
            callable=__get_mau_usage
        )

        def __get_mau_usage_by_category(
            self,
            **kwargs
        ):
            """Get MAU usage by category  # noqa: E501

            Get time-series arrays of the number of monthly active users (MAU) seen by LaunchDarkly from your account, broken down by the category of users. The category is either `browser`, `mobile`, or `backend`.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.get_mau_usage_by_category = _Endpoint(
            settings={
                'response_type': (SeriesListRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__get_mau_usage_by_category
        )

        def __get_stream_usage(
            self,
            source,
            **kwargs
        ):
        ...
        self.get_stream_usage = _Endpoint(
            settings={
                'response_type': (SeriesListRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__get_stream_usage
        )

        def __get_stream_usage_by_sdk_version(
            self,
            source,
            **kwargs
        ):
        ...
        self.get_stream_usage_by_sdk_version = _Endpoint(
            settings={
                'response_type': (SeriesListRep,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__get_stream_usage_by_sdk_version
        )

        def __get_stream_usage_sdkversion(
            self,
            source,
            **kwargs
        ):
        ...
        self.get_stream_usage_sdkversion = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_stream_usage_sdkversion
        )
