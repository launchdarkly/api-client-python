...
class DataExportDestinationsApi:
    ...
    @validate_call
    def post_complete_warehouse_destination_setup(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks)")],
        complete_setup_post_body: CompleteSetupPostBody,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param proj_key: The project key (required)
        :type proj_key: str
        :param env_key: The environment key (required)
        :type env_key: str
        :param kind: The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks) (required)
        :type kind: str
        :param complete_setup_post_body: (required)
        :type complete_setup_post_body: CompleteSetupPostBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_complete_warehouse_destination_setup_serialize(
            proj_key=proj_key,
            env_key=env_key,
            kind=kind,
            complete_setup_post_body=complete_setup_post_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_complete_warehouse_destination_setup_with_http_info(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks)")],
    ...
    @validate_call
    def post_complete_warehouse_destination_setup_without_preload_content(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks)")],
    ...
    def _post_complete_warehouse_destination_setup_serialize(
        self,
        proj_key,
        env_key,
        kind,
        complete_setup_post_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if proj_key is not None:
            _path_params['projKey'] = proj_key
        if env_key is not None:
            _path_params['envKey'] = env_key
        if kind is not None:
        ...
        # process the form parameters
        # process the body parameter
        if complete_setup_post_body is not None:
            _body_params = complete_setup_post_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/complete-setup',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_generate_project_env_warehouse_destination_key_pair(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
        ...
        _param = self._post_generate_project_env_warehouse_destination_key_pair_serialize(
            proj_key=proj_key,
            env_key=env_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "GenerateWarehouseDestinationKeyPairPostRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '409': "StatusConflictErrorRep",
    ...
    @validate_call
    def post_generate_project_env_warehouse_destination_key_pair_with_http_info(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    @validate_call
    def post_generate_project_env_warehouse_destination_key_pair_without_preload_content(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    def _post_generate_project_env_warehouse_destination_key_pair_serialize(
        self,
        proj_key,
        env_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/projects/{projKey}/environments/{envKey}/generate-warehouse-destination-key-pair',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_generate_trust_policy(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
        ...
        _param = self._post_generate_trust_policy_serialize(
            proj_key=proj_key,
            env_key=env_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "GenerateTrustPolicyPostRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '409': "StatusConflictErrorRep",
    ...
    @validate_call
    def post_generate_trust_policy_with_http_info(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    @validate_call
    def post_generate_trust_policy_without_preload_content(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    def _post_generate_trust_policy_serialize(
        self,
        proj_key,
        env_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/projects/{projKey}/environments/{envKey}/generate-trust-policy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_generate_warehouse_destination_key_pair(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._post_generate_warehouse_destination_key_pair_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_generate_warehouse_destination_key_pair_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def post_generate_warehouse_destination_key_pair_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _post_generate_warehouse_destination_key_pair_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/generate-warehouse-destination-key-pair',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_generate_warehouse_destination_setup_script(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, redshift, clickhouse)")],
        warehouse_setup_script_post_body: Optional[WarehouseSetupScriptPostBody] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type kind: str
        :param warehouse_setup_script_post_body:
        :type warehouse_setup_script_post_body: WarehouseSetupScriptPostBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_generate_warehouse_destination_setup_script_serialize(
            proj_key=proj_key,
            env_key=env_key,
            kind=kind,
            warehouse_setup_script_post_body=warehouse_setup_script_post_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "WarehouseDestinationSetupScriptRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '429': "RateLimitedErrorRep",
    ...
    @validate_call
    def post_generate_warehouse_destination_setup_script_with_http_info(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, redshift, clickhouse)")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WarehouseDestinationSetupScriptRep]:
        """Generate warehouse destination setup script
    ...
    @validate_call
    def post_generate_warehouse_destination_setup_script_without_preload_content(
        self,
        proj_key: Annotated[StrictStr, Field(description="The project key")],
        env_key: Annotated[StrictStr, Field(description="The environment key")],
        kind: Annotated[StrictStr, Field(description="The destination kind (snowflake-v2, redshift, clickhouse)")],
    ...
    def _post_generate_warehouse_destination_setup_script_serialize(
        self,
        proj_key,
        env_key,
        kind,
        warehouse_setup_script_post_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if warehouse_setup_script_post_body is not None:
            _body_params = warehouse_setup_script_post_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/setup',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
