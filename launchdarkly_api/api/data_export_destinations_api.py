    ...
    def __init__(self, api_client=None):
        ...
        def __delete_destination(
            ...
            **kwargs
            ...
            Delete Data Export destination by ID  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_destination(proj_key, env_key, id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_destination = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/destinations/{projKey}/{envKey}/{id}',
        ...
        def __get_destination(
            ...
            **kwargs
            ...
            >>> thread = api.get_destination(proj_key, env_key, id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_destination = _Endpoint(
            settings={
        ...
        self.get_destinations = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_destinations
        )

        def __patch_destination(
            self,
            proj_key,
            env_key,
            id,
            ...
            **kwargs
            ...
            >>> thread = api.patch_destination(proj_key, env_key, id, json_patch, async_req=True)
            >>> result = thread.get()
        ...
        self.patch_destination = _Endpoint(
            settings={
                'response_type': (Destination,),
                'auth': [
                    'ApiKey'
            ...
            api_client=api_client,
            callable=__patch_destination
        )

        def __post_destination(
            self,
            proj_key,
            env_key,
            destination_post,
            **kwargs
            ...
            Create a new destination. The `config` body parameter represents the configuration parameters required for a destination type.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.post_destination(proj_key, env_key, destination_post, async_req=True)
            >>> result = thread.get()
        ...
        self.post_destination = _Endpoint(
            settings={
                'response_type': (Destination,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/destinations/{projKey}/{envKey}',
