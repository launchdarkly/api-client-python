...
class DataExportDestinationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_generate_warehouse_destination_key_pair_endpoint = _Endpoint(
            settings={
                'response_type': (GenerateWarehouseDestinationKeyPairPostRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/destinations/generate-warehouse-destination-key-pair',
                'operation_id': 'post_generate_warehouse_destination_key_pair',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def patch_destination(
        ...
        **kwargs
        ...
        Update a Data Export destination. Updating a destination uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) or [JSON merge patch](https://datatracker.ietf.org/doc/html/rfc7386) representation of the desired changes. To learn more, read [Updates](https://launchdarkly.com/docs/api#updates).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_generate_warehouse_destination_key_pair(
        ...
        **kwargs
        ...
        """Generate Snowflake destination key pair  # noqa: E501

        Generate key pair to allow Data Export to authenticate into a Snowflake warehouse destination  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_generate_warehouse_destination_key_pair(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.post_generate_warehouse_destination_key_pair_endpoint.call_with_http_info(**kwargs)
