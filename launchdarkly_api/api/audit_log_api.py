...
class AuditLogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_audit_log_entries_endpoint = _Endpoint(
            settings={
                'response_type': (AuditLogEntryListingRepCollection,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/auditlog',
                'operation_id': 'post_audit_log_entries',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def post_audit_log_entries(
        ...
        **kwargs
        ...
        """Search audit log entries  # noqa: E501
        ...
        >>> thread = api.post_audit_log_entries(async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            q (str): Text to search for. You can search for the full or partial name of the resource.. [optional]
            limit (int): A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.. [optional]
            statement_post_list (StatementPostList): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.post_audit_log_entries_endpoint.call_with_http_info(**kwargs)
