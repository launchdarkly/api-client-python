...
class AuditLogApi:
    ...
    @validate_call
    def post_audit_log_entry_counts(
        self,
        after: Annotated[StrictInt, Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Required.")],
        statement_post: List[StatementPost],
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Defaults to now.")] = None,
        buckets: Annotated[Optional[StrictInt], Field(description="Number of time buckets to divide the range into. Default 50, max 500.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type after: int
        :param statement_post: (required)
        :type statement_post: List[StatementPost]
        :param before: A timestamp filter, expressed as a Unix epoch time in milliseconds. Defaults to now.
        :type before: int
        :param buckets: Number of time buckets to divide the range into. Default 50, max 500.
        :type buckets: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._post_audit_log_entry_counts_serialize(
            after=after,
            statement_post=statement_post,
            before=before,
            buckets=buckets,
    ...
    @validate_call
    def post_audit_log_entry_counts_with_http_info(
        self,
        after: Annotated[StrictInt, Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Required.")],
        statement_post: List[StatementPost],
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Defaults to now.")] = None,
    ...
    @validate_call
    def post_audit_log_entry_counts_without_preload_content(
        self,
        after: Annotated[StrictInt, Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Required.")],
        statement_post: List[StatementPost],
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. Defaults to now.")] = None,
    ...
    def _post_audit_log_entry_counts_serialize(
        self,
        after,
        statement_post,
        before,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/auditlog/counts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
