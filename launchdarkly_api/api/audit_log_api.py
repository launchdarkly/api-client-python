...
class AuditLogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_audit_log_entries(
            self,
            **kwargs
        ):
            """List audit log feature flag entries  # noqa: E501

            Get a list of all audit log entries. The query parameters let you restrict the results that return by date ranges, resource specifiers, or a full-text search query.  # noqa: E501
        ...
        self.get_audit_log_entries = _Endpoint(
            settings={
            ...
            callable=__get_audit_log_entries
        )

        def __get_audit_log_entry(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_audit_log_entry = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_audit_log_entry
        )
