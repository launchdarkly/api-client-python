...
class InsightsPullRequestsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_pull_requests_endpoint = _Endpoint(
            settings={
                'response_type': (PullRequestCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/pull-requests',
                'operation_id': 'get_pull_requests',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_pull_requests(
        ...
        **kwargs
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_pull_requests_endpoint.call_with_http_info(**kwargs)
