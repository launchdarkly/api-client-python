...
class MetricsBetaApi:
    ...
    def get_metric_groups(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `experimentStatus`, `query`, `kind`, `hasConnections`, `maintainerIds`, and `maintainerTeamKey`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.")] = None,
        ...
        expand: Annotated[Optional[StrictStr], Field(description="This parameter is reserved for future use and is not currently supported on this endpoint.")] = None,
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param filter: Accepts filter by `experimentStatus`, `query`, `kind`, `hasConnections`, `maintainerIds`, and `maintainerTeamKey`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.
        :type filter: str
        ...
        :type sort: str
        :param expand: This parameter is reserved for future use and is not currently supported on this endpoint.
        :type expand: str
