...
class MetricsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_metric_group_endpoint = _Endpoint(
            settings={
                'response_type': (MetricGroupRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/metric-groups',
                'operation_id': 'create_metric_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_metric_group_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}',
                'operation_id': 'delete_metric_group',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_metric_group_endpoint = _Endpoint(
            settings={
                'response_type': (MetricGroupRep,),
                'auth': [
                    'ApiKey'
        ...
        self.get_metric_groups_endpoint = _Endpoint(
            settings={
                'response_type': (MetricGroupCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/projects/{projectKey}/metric-groups',
                'operation_id': 'get_metric_groups',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_metric_group_endpoint = _Endpoint(
            settings={
                'response_type': (MetricGroupRep,),
                'auth': [
                    'ApiKey'
                ...
                'endpoint_path': '/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}',
                'operation_id': 'patch_metric_group',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def create_metric_group(
        ...
        **kwargs
        ...
        """Create metric group  # noqa: E501

        Create a new metric group in the specified project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_metric_group(project_key, metric_group_post, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_key'] = \
            project_key
        kwargs['metric_group_post'] = \
            metric_group_post
        return self.create_metric_group_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_metric_group(
        ...
        **kwargs
        ...
        """Delete metric group  # noqa: E501

        Delete a metric group by key.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_metric_group(project_key, metric_group_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_group_key'] = \
            metric_group_key
        return self.delete_metric_group_endpoint.call_with_http_info(**kwargs)
    ...
    def get_metric_group(
        ...
        **kwargs
        ...
        >>> thread = api.get_metric_group(project_key, metric_group_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['metric_group_key'] = \
            metric_group_key
        return self.get_metric_group_endpoint.call_with_http_info(**kwargs)
    ...
    def get_metric_groups(
        ...
        **kwargs
        ...
        kwargs['project_key'] = \
            project_key
        return self.get_metric_groups_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_metric_group(
        ...
        **kwargs
        ...
        """Patch metric group  # noqa: E501

        Patch a metric group by key. Updating a metric group uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_metric_group(project_key, metric_group_key, json_patch, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['json_patch'] = \
            json_patch
        return self.patch_metric_group_endpoint.call_with_http_info(**kwargs)
