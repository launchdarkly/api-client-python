...
class ContextsApi:
    ...
    def get_context_kinds_by_project_key(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response. Options: `environmentObservations`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param expand: A comma-separated list of properties that can reveal additional information in the response. Options: `environmentObservations`.
        :type expand: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
