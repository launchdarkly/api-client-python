    ...
    def __init__(self, api_client=None):
        ...
        def __get_experiment(
            ...
            **kwargs
            ...
            Get detailed experiment result data  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_experiment(proj_key, flag_key, env_key, metric_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_experiment = _Endpoint(
            settings={
                'response_type': (ExperimentResultsRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}',
            ...
            callable=__get_experiment
        )

        def __reset_experiment(
            self,
            proj_key,
            flag_key,
            env_key,
            ...
            **kwargs
            ...
            >>> thread = api.reset_experiment(proj_key, flag_key, env_key, metric_key, async_req=True)
            >>> result = thread.get()
        ...
        self.reset_experiment = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}/results',
