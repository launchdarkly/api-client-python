...
class UserSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_expiring_flags_for_user(
            self,
            proj_key,
            user_key,
            env_key,
            **kwargs
            ...
            >>> thread = api.get_expiring_flags_for_user(proj_key, user_key, env_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_expiring_flags_for_user = _Endpoint(
            settings={
                'response_type': (ExpiringUserTargetGetResponse,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projKey}/{userKey}/expiring-user-targets/{envKey}',
            ...
            callable=__get_expiring_flags_for_user
        )

        def __get_user_flag_setting(
            self,
            proj_key,
            env_key,
            key,
            ...
            **kwargs
            ...
            Get a single flag setting for a user by key. The most important attribute in the response is the `_value`. The `_value` is the current setting that the user sees. For a boolean feature toggle, this is `true`, `false`, or `null`. `null` returns if there is no defined fallback value. The example response indicates that the user `Abbie_Braun` has the `sort.order` flag enabled.<br /><br />The setting attribute indicates whether you've explicitly targeted a user to receive a particular variation. For example, if you have turned off a feature flag for a user, this setting will be `false`. A setting of `null` means that you haven't assigned that user to a specific variation.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_user_flag_setting(proj_key, env_key, key, feature_key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_user_flag_setting = _Endpoint(
            settings={
                'response_type': (UserFlagSetting,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projKey}/{envKey}/{key}/flags/{featureKey}',
            ...
            api_client=api_client,
            callable=__get_user_flag_setting
        )

        def __get_user_flag_settings(
            self,
            proj_key,
            env_key,
            key,
            **kwargs
            ...
            Get the current flag settings for a given user. The most important attribute in the response is the `_value`. The `_value` is the setting that the user sees. For a boolean feature toggle, this is `true`, `false`, or `null`. `null` returns if there is no defined fallthrough value. The example response indicates that the user `Abbie_Braun` has the `sort.order` flag enabled and the `alternate.page` flag disabled.<br /><br />The setting attribute indicates whether you've explicitly targeted a user to receive a particular variation. For example, if you have turned off a feature flag for a user, this setting will be `false`. A setting of `null` means that you haven't assigned that user to a specific variation.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_user_flag_settings(proj_key, env_key, key, async_req=True)
            >>> result = thread.get()
        ...
        self.get_user_flag_settings = _Endpoint(
            settings={
                'response_type': (UserFlagSettings,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/users/{projKey}/{envKey}/{key}/flags',
            ...
            api_client=api_client,
            callable=__get_user_flag_settings
        )

        def __patch_expiring_flags_for_user(
            self,
            proj_key,
            user_key,
            env_key,
            ...
            **kwargs
            ...
            >>> thread = api.patch_expiring_flags_for_user(proj_key, user_key, env_key, patch_with_comment, async_req=True)
            >>> result = thread.get()
        ...
        self.patch_expiring_flags_for_user = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__patch_expiring_flags_for_user
        )

        def __put_flag_setting(
            self,
            proj_key,
            env_key,
            key,
            ...
            **kwargs
            ...
            >>> thread = api.put_flag_setting(proj_key, env_key, key, feature_key, value_put, async_req=True)
            >>> result = thread.get()
        ...
        self.put_flag_setting = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
