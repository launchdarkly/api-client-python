...
class InsightsDeploymentsBetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_deployment_event_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/deployment-events',
                'operation_id': 'create_deployment_event',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'post_deployment_event_input': 'body',
                },
        ...
        self.get_deployment_endpoint = _Endpoint(
            settings={
                'response_type': (DeploymentRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/deployments/{deploymentID}',
        ...
        self.get_deployments_endpoint = _Endpoint(
            settings={
                'response_type': (DeploymentCollectionRep,),
                'auth': [
                    'ApiKey'
                ],
                'endpoint_path': '/api/v2/engineering-insights/deployments',
    ...
    def create_deployment_event(
        ...
        **kwargs
        ...
        """Create deployment event  # noqa: E501

        Create deployment event  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_deployment_event(post_deployment_event_input, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_deployment_event_input'] = \
            post_deployment_event_input
        return self.create_deployment_event_endpoint.call_with_http_info(**kwargs)
    ...
    def get_deployments(
        ...
        **kwargs
        ...
        >>> thread = api.get_deployments(project_key, environment_key, async_req=True)
        >>> result = thread.get()
