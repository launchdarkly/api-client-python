...
class UserSegment(object):
    ...
    def __init__(self, key=None, name=None, description=None, tags=None, creation_date=None, included=None, excluded=None, rules=None, version=None, links=None, flags=None):  # noqa: E501
