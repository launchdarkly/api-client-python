...
class FeatureFlagConfig(object):
    ...
    def __init__(self, on=None, archived=None, salt=None, sel=None, last_modified=None, version=None, targets=None, rules=None, fallthrough=None, off_variation=None, prerequisites=None, track_events=None, track_events_fallthrough=None):  # noqa: E501
