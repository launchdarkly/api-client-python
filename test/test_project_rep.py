...
class TestProjectRep(unittest.TestCase):
    """ProjectRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectRep:
        """Test ProjectRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectRep`
        """
        model = ProjectRep()
        if include_optional:
            return ProjectRep(
                links = {"environments":{"href":"/api/v2/projects/my-project/environments","type":"application/json"},"self":{"href":"/api/v2/projects/my-project","type":"application/json"}},
