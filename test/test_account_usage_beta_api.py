...
class TestAccountUsageBetaApi(unittest.TestCase):
    """AccountUsageBetaApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AccountUsageBetaApi()

    def tearDown(self) -> None:
        pass

    def test_get_ai_runs_usage(self) -> None:
        """Test case for get_ai_runs_usage

        Get AI runs usage
        """
        pass

    def test_get_contexts_clientside_usage(self) -> None:
        """Test case for get_contexts_clientside_usage

        Get contexts clientside usage
        """
        pass

    def test_get_contexts_serverside_usage(self) -> None:
        """Test case for get_contexts_serverside_usage

        Get contexts serverside usage
        """
        pass

    def test_get_contexts_total_usage(self) -> None:
        """Test case for get_contexts_total_usage

        Get contexts total usage
        """
        pass

    def test_get_data_export_events_usage(self) -> None:
    ...
    def test_get_evaluations_usage(self) -> None:
    ...
    def test_get_experimentation_events_usage(self) -> None:
        """Test case for get_experimentation_events_usage

        Get experimentation events usage
        """
        pass

    def test_get_experimentation_keys_usage(self) -> None:
        """Test case for get_experimentation_keys_usage
    ...
    def test_get_mau_usage(self) -> None:
        """Test case for get_mau_usage

        Get MAU usage
        """
        pass

    def test_get_mau_usage_by_category(self) -> None:
    ...
    def test_get_observability_errors_usage(self) -> None:
        """Test case for get_observability_errors_usage

        Get observability errors usage
        """
        pass

    def test_get_observability_logs_usage(self) -> None:
        """Test case for get_observability_logs_usage
    ...
    def test_get_observability_traces_usage(self) -> None:
        """Test case for get_observability_traces_usage

        Get observability traces usage
        """
        pass

    def test_get_sdk_all_versions(self) -> None:
        """Test case for get_sdk_all_versions

        Get usage details for all SDK versions
        """
        pass

    def test_get_sdk_versions_details(self) -> None:
        """Test case for get_sdk_versions_details

        Get SDK versions usage details
        """
        pass

    def test_get_service_connections_usage(self) -> None:
        """Test case for get_service_connections_usage

        Get service connections usage
        """
        pass

    def test_get_stream_usage(self) -> None:
        """Test case for get_stream_usage

        Get stream usage
        """
        pass

    def test_get_stream_usage_by_sdk_version(self) -> None:
        """Test case for get_stream_usage_by_sdk_version

        Get stream usage by SDK version
        """
        pass

    def test_get_stream_usage_sdkversion(self) -> None:
    ...
    def test_get_warehouse_export_usage(self) -> None:
        """Test case for get_warehouse_export_usage
