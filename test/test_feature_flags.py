...
class TestFeatureFlags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FeatureFlags:
        ...
        if include_optional:
            return FeatureFlags(
                items = [
                    launchdarkly_api.models.feature_flag.FeatureFlag(
                        name = 'My Flag', 
                        kind = 'boolean', 
                        ...
                        _maintainer_team = launchdarkly_api.models.maintainer_team.MaintainerTeam(
                            key = 'team-key-123abc', 
                            name = 'Example team', 
                ...
                links = {"self":{"href":"/api/v2/flags/default","type":"application/json"}},
                total_count = 1,
