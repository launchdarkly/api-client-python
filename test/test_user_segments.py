...
class TestUserSegments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserSegments:
        """Test UserSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSegments`
        """
        model = UserSegments()
        if include_optional:
            return UserSegments(
                items = [
                    launchdarkly_api.models.user_segment.UserSegment(
