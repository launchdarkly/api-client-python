...
class TestHoldoutRep(unittest.TestCase):
    """HoldoutRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldoutRep:
        """Test HoldoutRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldoutRep`
        """
        model = HoldoutRep()
        if include_optional:
            return HoldoutRep(
                ...
                experiments = [
                    launchdarkly_api.models.related_experiment_rep.RelatedExperimentRep(
                        key = '', 
                        name = '', 
                        environment = '', )
                    ]
