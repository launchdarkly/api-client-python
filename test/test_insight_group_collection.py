...
class TestInsightGroupCollection(unittest.TestCase):
    """InsightGroupCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsightGroupCollection:
        """Test InsightGroupCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsightGroupCollection`
        """
        model = InsightGroupCollection()
        if include_optional:
            return InsightGroupCollection(
                total_count = 15,
                items = [
                    launchdarkly_api.models.insight_group.InsightGroup(
                        environment = launchdarkly_api.models.environment.Environment(
                            ...
                            critical = True, ), 
                        scores = launchdarkly_api.models.insight_group_scores.InsightGroupScores(
                            overall = launchdarkly_api.models.insights_metric_score.InsightsMetricScore(
                                score = 100, 
                                aggregate_of = ["deploymentFrequency","leadTime"], 
                                diff_vs_last_period = 56, 
                                indicator = '', 
                                indicator_range = launchdarkly_api.models.insights_metric_indicator_range.InsightsMetricIndicatorRange(
                                    min = 0, 
                                    max = 100, ), 
                                last_period = launchdarkly_api.models.insights_metric_score.InsightsMetricScore(
                                    score = 100, 
                                    aggregate_of = ["deploymentFrequency","leadTime"], 
                                    diff_vs_last_period = 56, 
                                    indicator = '', 
                            ...
                            efficiency = , 
                            creation_ratio = , ), 
                        score_metadata = launchdarkly_api.models.insight_group_collection_score_metadata.InsightGroupCollectionScoreMetadata(
                            period = launchdarkly_api.models.insight_period.InsightPeriod(
                                start_time = 56, 
                                end_time = 56, ), 
                            last_period = launchdarkly_api.models.insight_period.InsightPeriod(
                                start_time = 56, 
                                end_time = 56, ), ), 
                ...
                metadata = launchdarkly_api.models.insight_group_collection_metadata.InsightGroupCollectionMetadata(
                    count_by_indicator = launchdarkly_api.models.insight_groups_count_by_indicator.InsightGroupsCountByIndicator(
                        excellent = 1, 
                        good = 1, 
                        fair = 1, 
                        needs_attention = 1, 
    ...
    def testInsightGroupCollection(self):
        """Test InsightGroupCollection"""
