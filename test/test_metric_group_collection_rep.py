...
class TestMetricGroupCollectionRep(unittest.TestCase):
    """MetricGroupCollectionRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricGroupCollectionRep:
        """Test MetricGroupCollectionRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetricGroupCollectionRep`
        """
        model = MetricGroupCollectionRep()
        if include_optional:
            return MetricGroupCollectionRep(
                items = [
                    launchdarkly_api.models.metric_group_rep.MetricGroupRep(
                        ...
                        _creation_date = 56, 
                        _last_modified = 56, 
                        maintainer = launchdarkly_api.models.maintainer_rep.MaintainerRep(
                            key = '569fdeadbeef1644facecafe', 
                            kind = 'member', 
                            _member = launchdarkly_api.models.member_summary.MemberSummary(
                            ...
                            _team = launchdarkly_api.models.member_team_summary_rep.MemberTeamSummaryRep(
    ...
    def testMetricGroupCollectionRep(self):
        """Test MetricGroupCollectionRep"""
