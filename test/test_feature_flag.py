    ...
    def make_instance(self, include_optional) -> FeatureFlag:
        ...
        if include_optional:
            return FeatureFlag(
                ...
                temporary = True,
                tags = ["example-tag"],
                links = {"parent":{"href":"/api/v2/flags/my-project","type":"application/json"},"self":{"href":"/api/v2/flags/my-project/my-flag","type":"application/json"}},
                maintainer_id = '569f183514f4432160000007',
                maintainer = launchdarkly_api.models.member_summary.MemberSummary(
                ...
                maintainer_team = launchdarkly_api.models.maintainer_team.MaintainerTeam(
                    key = 'team-key-123abc', 
                    name = 'Example team', 
                ...
                goal_ids = [],
                experiments = launchdarkly_api.models.experiment_info_rep.ExperimentInfoRep(
                    baseline_idx = 56, 
                    items = [
                        launchdarkly_api.models.legacy_experiment_rep.LegacyExperimentRep(
                            metric_key = 'my-metric', 
                            _metric = launchdarkly_api.models.metric_listing_rep.MetricListingRep(
                                experiment_count = 0, 
                                ...
                                tags = [], 
                                _creation_date = 56, 
                                last_modified = launchdarkly_api.models.modification.Modification(
                                ...
                                analysis_units = ["user"], 
                                filters = launchdarkly_api.models.filter.Filter(
                                ...
                                analysis_type = 'mean', 
                                percentile_value = 95, 
                                event_default = launchdarkly_api.models.metric_event_default_rep.MetricEventDefaultRep(
                                    disabled = True, 
                                    value = 0, ), 
                                ...
                                window_start_offset = 56, 
                                window_end_offset = 56, 
                                ...
                                denominator = launchdarkly_api.models.metric_denominator_rep.MetricDenominatorRep(
                                    event_name = '', 
                                    is_numeric = True, 
                                    ...
                                    window_start_offset = 56, 
                                    window_end_offset = 56, 
                                    winsor_lower_percentile = 1.337, 
                                    winsor_upper_percentile = 1.337, 
                                    winsor_include_imputed = True, ), ), 
                            environments = ["production","test","my-environment"], 
                            _environment_settings = {
                                'key' : launchdarkly_api.models.experiment_environment_setting_rep.ExperimentEnvironmentSettingRep(
                                    start_date = 56, 
                                    stop_date = 56, 
                                    enabled_periods = [
                                        launchdarkly_api.models.experiment_enabled_period_rep.ExperimentEnabledPeriodRep(
                                            start_date = 56, 
                                            stop_date = 56, )
                                        ], )
                                }, )
                ...
                defaults = launchdarkly_api.models.defaults.Defaults(
                    ...
                    off_variation = 1, ),
                purpose = '',
                migration_settings = launchdarkly_api.models.flag_migration_settings_rep.FlagMigrationSettingsRep(
                    context_kind = 'device', 
                    stage_count = 6, ),
                stale = launchdarkly_api.models.stale_flag_data.StaleFlagData(
                    ready_for_code_removal = True, 
