    ...
    def make_instance(self, include_optional) -> Experiment:
        ...
        if include_optional:
            return Experiment(
                ...
                links = {"parent":{"href":"/api/v2/projects/my-project/environments/my-environment","type":"application/json"},"self":{"href":"/api/v2/projects/my-project/environments/my-environment/experiments/my-experiment","type":"application/json"}},
