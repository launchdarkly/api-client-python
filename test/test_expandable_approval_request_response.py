...
class TestExpandableApprovalRequestResponse(unittest.TestCase):
    """ExpandableApprovalRequestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpandableApprovalRequestResponse:
        """Test ExpandableApprovalRequestResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpandableApprovalRequestResponse`
        """
        model = ExpandableApprovalRequestResponse()
        if include_optional:
    ...
    def testExpandableApprovalRequestResponse(self):
        """Test ExpandableApprovalRequestResponse"""
