...
class TestHoldoutDetailRep(unittest.TestCase):
    """HoldoutDetailRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldoutDetailRep:
        """Test HoldoutDetailRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldoutDetailRep`
        """
        model = HoldoutDetailRep()
        if include_optional:
            return HoldoutDetailRep(
                ...
                created_at = 56,
                updated_at = 56,
                base_experiment = launchdarkly_api.models.experiment.Experiment(
