...
class TestExperimentCollectionRep(unittest.TestCase):
    """ExperimentCollectionRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentCollectionRep:
        """Test ExperimentCollectionRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentCollectionRep`
        """
        model = ExperimentCollectionRep()
        if include_optional:
            return ExperimentCollectionRep(
                items = [
                    launchdarkly_api.models.experiment.Experiment(
                        ...
                        current_iteration = launchdarkly_api.models.iteration_rep.IterationRep(
                            ...
                            version = 0, 
                            primary_metric = launchdarkly_api.models.dependent_metric_or_metric_group_rep.DependentMetricOrMetricGroupRep(
                                ...
                                is_group = True, 
                                metrics = [
                                    launchdarkly_api.models.metric_in_group_rep.MetricInGroupRep(
                                        key = 'metric-key-123abc', 
                            ...
                            primary_single_metric = launchdarkly_api.models.metric_v2_rep.MetricV2Rep(
                                key = 'metric-key-123abc', 
                                _version_id = 'version-id-123abc', 
                                name = 'Example metric', 
                                kind = 'custom', 
                                ...
                                event_key = 'event-key-123abc', 
                                _links = {"self":{"href":"/api/v2/metrics/my-project/my-metric","type":"application/json"}}, ), 
                            primary_funnel = launchdarkly_api.models.dependent_metric_group_rep_with_metrics.DependentMetricGroupRepWithMetrics(
                            ...
                            treatments = [
                                launchdarkly_api.models.treatment_rep.TreatmentRep(
                                    _id = '122c9f3e-da26-4321-ba68-e0fc02eced58', 
                                    name = 'Treatment 1', 
                                    allocation_percent = '10', 
                                    baseline = True, 
                                    parameters = [
                                        launchdarkly_api.models.parameter_rep.ParameterRep(
                                            variation_id = '', 
                                            flag_key = '', )
                                        ], )
                                ], 
                            secondary_metrics = [
                                launchdarkly_api.models.metric_v2_rep.MetricV2Rep(
                                    key = 'metric-key-123abc', 
                                    _version_id = 'version-id-123abc', 
                                    name = 'Example metric', 
                                    kind = 'custom', 
                            ...
                            metrics = [
                                launchdarkly_api.models.dependent_metric_or_metric_group_rep.DependentMetricOrMetricGroupRep(
                                    key = 'metric-key-123abc', 
                                    _version_id = '', 
                                    name = 'My metric', 
                                    kind = 'custom', 
                            ...
                            layer_snapshot = launchdarkly_api.models.layer_snapshot_rep.LayerSnapshotRep(
                                key = 'checkout-flow', 
                                name = 'Checkout Flow', 
                                reservation_percent = 10, 
                                other_reservation_percent = 70, ), 
                            covariate_info = launchdarkly_api.models.covariate_info_rep.CovariateInfoRep(
                        ...
                        analysis_config = launchdarkly_api.models.analysis_config_rep.AnalysisConfigRep(
                            bayesian_threshold = '', 
                        ...
                        mutable_fields_by_status = launchdarkly_api.models.mutable_fields_by_status_rep.MutableFieldsByStatusRep(
                            not_started = {
                                'key' : [
                                    ''
                                    ]
    ...
    def testExperimentCollectionRep(self):
        """Test ExperimentCollectionRep"""
