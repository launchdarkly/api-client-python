...
class TestDeploymentCollectionRep(unittest.TestCase):
    """DeploymentCollectionRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentCollectionRep:
        """Test DeploymentCollectionRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentCollectionRep`
        """
        model = DeploymentCollectionRep()
        if include_optional:
            return DeploymentCollectionRep(
                ...
                links = {"next":{"href":"/api/v2/engineering-insights/deployments?after=a4290006-1fd1-4ca5-acf7-9f31fac61cf5","type":"application/json"},"self":{"href":"/api/v2/engineering-insights/deployments","type":"application/json"}}
            )
        else:
            return DeploymentCollectionRep(
                total_count = 25,
    ...
    def testDeploymentCollectionRep(self):
        """Test DeploymentCollectionRep"""
