...
class TestPullRequestCollectionRep(unittest.TestCase):
    """PullRequestCollectionRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequestCollectionRep:
        """Test PullRequestCollectionRep
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequestCollectionRep`
        """
        model = PullRequestCollectionRep()
        if include_optional:
            return PullRequestCollectionRep(
                total_count = 25,
                items = [
                    launchdarkly_api.models.pull_request_rep.PullRequestRep(
                        ...
                        deployments = launchdarkly_api.models.deployment_collection_rep.DeploymentCollectionRep(
                            total_count = 25, 
                            items = [
                                launchdarkly_api.models.deployment_rep.DeploymentRep(
                                    id = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 
                                    ...
                                    lines_deleted = 50, 
                                    lead_time = 20237000, 
                                    pull_requests = launchdarkly_api.models.pull_request_collection_rep.PullRequestCollectionRep(
                                        total_count = 25, 
                                        items = [
                                            launchdarkly_api.models.pull_request_rep.PullRequestRep(
                                                id = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 
                                                ...
                                                lines_deleted = 50, 
                                                url = 'https://github.com/launchdarkly/LaunchDarkly-Docs/pull/406', 
                                                flag_references = launchdarkly_api.models.flag_reference_collection_rep.FlagReferenceCollectionRep(
                                                    total_count = 25, 
                                                    items = [
                                                        launchdarkly_api.models.flag_reference_rep.FlagReferenceRep(
                                                            project_key = 'default', 
                                                            flag_key = 'enable-new-payment-structure', 
                                                            references_added = 2, 
                                                            references_removed = 5, )
                                                        ], ), 
                                                lead_time = launchdarkly_api.models.pull_request_lead_time_rep.PullRequestLeadTimeRep(
                                    ...
                                    lead_time_stages = launchdarkly_api.models.lead_time_stages_rep.LeadTimeStagesRep(
                                        coding_duration_ms = 1000000, 
                                        review_duration_ms = 500000, 
                ...
                links = {"next":{"href":"/api/v2/engineering-insights/pull-requests?after=a4290006-1fd1-4ca5-acf7-9f31fac61cf5","type":"application/json"},"self":{"href":"/api/v2/engineering-insights/pull-requests","type":"application/json"}}
            )
        else:
            return PullRequestCollectionRep(
                total_count = 25,
    ...
    def testPullRequestCollectionRep(self):
        """Test PullRequestCollectionRep"""
