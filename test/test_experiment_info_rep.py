...
class TestExperimentInfoRep(unittest.TestCase):
    """ExperimentInfoRep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentInfoRep:
        """Test ExperimentInfoRep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentInfoRep`
        """
        model = ExperimentInfoRep()
        if include_optional:
    ...
    def testExperimentInfoRep(self):
        """Test ExperimentInfoRep"""
