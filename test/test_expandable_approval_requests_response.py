...
class TestExpandableApprovalRequestsResponse(unittest.TestCase):
    """ExpandableApprovalRequestsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpandableApprovalRequestsResponse:
        """Test ExpandableApprovalRequestsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpandableApprovalRequestsResponse`
        """
        model = ExpandableApprovalRequestsResponse()
        if include_optional:
            return ExpandableApprovalRequestsResponse(
                items = [
                    launchdarkly_api.models.expandable_approval_request_response.ExpandableApprovalRequestResponse(
                        ...
                        all_reviews = [
                            launchdarkly_api.models.review_response.ReviewResponse(
                                _id = '12ab3c45de678910abc12345', 
                                kind = 'approve', 
                                creation_date = 56, 
                                comment = 'Approved!', 
                        ...
                        conflicts = [
                            launchdarkly_api.models.conflict.Conflict(
                                instruction = {
                                    'key' : null
                                    }, 
                                reason = '', )
                        ...
                        integration_metadata = launchdarkly_api.models.integration_metadata.IntegrationMetadata(
                            external_id = '', 
                            external_status = launchdarkly_api.models.integration_status.IntegrationStatus(
                                display = '', 
                                value = '', ), 
                            external_url = '', 
                            last_checked = 56, ), 
                        source = launchdarkly_api.models.copied_from_env.CopiedFromEnv(
                            key = 'source-flag-key-123abc', 
                            version = 1, ), 
                        custom_workflow_metadata = launchdarkly_api.models.custom_workflow_meta.CustomWorkflowMeta(
                            name = 'Example workflow name', 
                            stage = launchdarkly_api.models.custom_workflow_stage_meta.CustomWorkflowStageMeta(
                                index = 0, 
                                name = 'Stage 1', ), ), 
                        resource_id = '', 
                        approval_settings = launchdarkly_api.models.approval_settings.ApprovalSettings(
                            required = True, 
                        ...
                        project = launchdarkly_api.models.project.Project(
                            ...
                            default_client_side_availability = launchdarkly_api.models.client_side_availability.ClientSideAvailability(
                                using_mobile_key = True, 
                                using_environment_id = True, ), 
                            name = 'My Project', 
                            _access = launchdarkly_api.models.access.Access(
                                denied = [
                            ...
                            environments = launchdarkly_api.models.environments.Environments(
                                total_count = 2, 
                                items = [
                                    launchdarkly_api.models.environment.Environment(
                                        ...
                                        resource_approval_settings = {
                                            'key' : launchdarkly_api.models.approval_settings.ApprovalSettings(
                                                required = True, 
                                                bypass_approvals_for_pending_changes = False, 
                                                min_num_approvals = 1, 
                                                can_review_own_request = False, 
                        ...
                        flag = launchdarkly_api.models.expanded_flag_rep.ExpandedFlagRep(
                            name = 'My Flag', 
                            kind = 'boolean', 
                            ...
                            client_side_availability = launchdarkly_api.models.client_side_availability.ClientSideAvailability(
                                using_mobile_key = True, 
                                using_environment_id = True, ), 
                            ...
                            _maintainer = launchdarkly_api.models.member_summary.MemberSummary(
                            ...
                            custom_properties = {
                                'key' : launchdarkly_api.models.custom_property.customProperty(
                                    name = 'Jira issues', 
                                    value = ["is-123","is-456"], )
                                }, 
                            archived = False, 
                            archived_date = 56, 
                            defaults = launchdarkly_api.models.defaults.Defaults(
                                on_variation = 0, 
                                off_variation = 1, ), ), 
                        resource = launchdarkly_api.models.expanded_resource_rep.ExpandedResourceRep(
                            kind = 'flag', 
                            ai_config = launchdarkly_api.models.ai_config_rep.AIConfigRep(
                                key = 'aiconfig-key-123abc', 
                                name = 'AI Config 1', ), 
                            experiment = launchdarkly_api.models.expanded_experiment_rep.ExpandedExperimentRep(
                                key = 'experiment-key-123abc', 
                                name = 'My Experiment', ), 
                            segment = launchdarkly_api.models.user_segment.UserSegment(
                                ...
                                included_contexts = [
                                    launchdarkly_api.models.segment_target.SegmentTarget(
                                        values = [
                                            ''
                                            ], 
                                        context_kind = '', )
                                ...
                                _links = {
                                    'key' : launchdarkly_api.models.link.Link(
                                        href = '', 
                                        type = '', )
                                    }, 
                                ...
                                deleted = False, 
                                _flags = [
                                    launchdarkly_api.models.flag_listing_rep.FlagListingRep(
                                        name = 'Example flag', 
                                        key = 'flag-key-123abc', 
                                        _site = launchdarkly_api.models.link.Link(
                                            href = '', 
                                            type = '', ), )
                                    ], 
                                unbounded = False, 
                                ...
                                generation = 56, 
                                _unbounded_metadata = launchdarkly_api.models.segment_metadata.SegmentMetadata(
                                    env_id = '', 
                                    segment_id = '', 
                                    version = 56, 
                                    included_count = 56, 
    ...
    def testExpandableApprovalRequestsResponse(self):
        """Test ExpandableApprovalRequestsResponse"""
