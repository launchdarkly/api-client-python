...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    api_instance = launchdarkly_api.HoldoutsApi(api_client)
    ...
    try:
        ...
        print("The response of HoldoutsApi->get_all_holdouts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HoldoutsApi->get_all_holdouts: %s\n" % e)
```
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HoldoutsApi->get_holdout:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HoldoutsApi->get_holdout: %s\n" % e)
```
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HoldoutsApi->get_holdout_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HoldoutsApi->get_holdout_by_id: %s\n" % e)
```
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HoldoutsApi->patch_holdout:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HoldoutsApi->patch_holdout: %s\n" % e)
```
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HoldoutsApi->post_holdout:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HoldoutsApi->post_holdout: %s\n" % e)
```
