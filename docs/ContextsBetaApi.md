...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->delete_context_instances: %s\n" % e)
```
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    filter = "filter_example" # str | A comma-separated list of filters. Each filter is of the form field:value. Supports the same filters as the List Feature Flags API. (optional)
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->evaluate_context_instance: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->get_context_attribute_names: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->get_context_attribute_values: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    filter = "filter_example" # str | A comma-separated list of context filters. This endpoint only accepts an `applicationId` filter. To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). (optional)
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->get_context_instances: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->get_contexts: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->search_context_instances: %s\n" % e)
...
with launchdarkly_api.ApiClient(configuration) as api_client:
    ...
    continuation_token = "continuationToken_example" # str | Limits results to contexts with sort values after the value specified. You can use this for pagination, however, we recommend using the `next` link we provide instead. (optional)
    sort = "sort_example" # str | Specifies a field by which to sort. LaunchDarkly supports sorting by timestamp in ascending order by specifying `ts` for this value, or descending order by specifying `-ts`. (optional)
    filter = "filter_example" # str | A comma-separated list of context filters. To learn more about the filter syntax, read [Filtering contexts and context instances](/tag/Contexts-(beta)#filtering-contexts-and-context-instances). (optional)
    include_total_count = True # bool | Specifies whether to include or omit the total count of matching contexts. Defaults to true. (optional)
    ...
    try:
        ...
        print("Exception when calling ContextsBetaApi->search_contexts: %s\n" % e)
