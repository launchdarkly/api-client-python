...
```python
from launchdarkly_api.models.sdk_key_for_put_sdk_key_views import SdkKeyForPutSdkKeyViews

# TODO update the JSON string below
json = "{}"
# create an instance of SdkKeyForPutSdkKeyViews from a JSON string
sdk_key_for_put_sdk_key_views_instance = SdkKeyForPutSdkKeyViews.from_json(json)
# print the JSON string representation of the object
print(SdkKeyForPutSdkKeyViews.to_json())

# convert the object into a dict
sdk_key_for_put_sdk_key_views_dict = sdk_key_for_put_sdk_key_views_instance.to_dict()
# create an instance of SdkKeyForPutSdkKeyViews from a dict
sdk_key_for_put_sdk_key_views_from_dict = SdkKeyForPutSdkKeyViews.from_dict(sdk_key_for_put_sdk_key_views_dict)
```
